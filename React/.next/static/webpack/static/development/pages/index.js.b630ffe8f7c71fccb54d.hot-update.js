        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(llamados.datosTabla('json={"id":"funRegistroGarantias"}').then(function (data) {
                _this2.setState({
                  fiduca: data
                });
              }));
            ...
            case 3:
              console.log(llamados.filas); //this.setState({fiduca: llamados.filas});
...
//# sourceMappingURL=index.js.b630ffe8f7c71fccb54d.hot-update.js.map