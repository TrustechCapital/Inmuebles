import { ReporteState, ReportesActions } from '../types';
import Individualizacion from '../../../../models/Individualizacion';
import { OperacionesCatalogo, SavingStatus } from '../../../../constants';

function ReportesReducer(
    state: ReporteState,
    action: ReportesActions
): ReporteState {
    switch (action.type) {
        case 'SET_REPORTES_SEARCH_PARAMETERS':
            return {
                ...state,
        ...
        case 'OPEN_REPORTES_MODAL':
            ...
            return state;
        case 'CLOSE_REPORTES_MODAL':
            return {
                ...state,
                modalOpen: false,
            };
        case 'SAVE_REPORTES_MODEL':
            return {
                ...state,
