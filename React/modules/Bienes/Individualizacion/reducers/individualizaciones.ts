import { IndividualizacionesState, IndividualizacionesActions } from '../types';
import Individualizacion from '../../../../models/Individualizacion';
import { OperacionesCatalogo, SavingStatus } from '../../../../constants';

function IndividualizacionesReducer(
    state: IndividualizacionesState,
    action: IndividualizacionesActions
): IndividualizacionesState {
    switch (action.type) {
        case 'SET_INDIVIDUALIZACIONES_SEARCH_PARAMETERS':
            return {
                ...state,
        ...
        case 'SET_INDIVIDUALIZACIONES_ROWS_SELECTION':
        ...
        case 'SET_INDIVIDUALIZACIONES_MODEL':
            return {
                ...state,
                currentModel: action.model,
            };
        case 'OPEN_INDIVIDUALIZACIONES_MODAL':
            ...
            return state;
        case 'CLOSE_INDIVIDUALIZACIONES_MODAL':
            return {
                ...state,
                modalOpen: false,
            };
        case 'SAVE_INDIVIDUALIZACIONES_MODEL':
            return {
                ...state,
...
export { IndividualizacionesReducer };
