...
export default function DialogLiberaciones(props) {
    ...
    return (
        <CatalogDialog
            ...
            nombreCatalogo="Individualización"
            subtitle="Individualización de Inmuebles (Unidades Condominales)"
        ...
        >
            ...
            >
                ...
                <Grid container className={classes.rowSpacing} spacing={3}>
                    <Grid item xs={6}>
                        <GenericDatePicker
                            idSelector="funiFechaReversion"
                            labelSelector="Fecha Reversión"
                            selectedDate={selectedDate}
                            onChange={handleDateChangeSal}
                        />
                    </Grid>
