            ...
            <Paper elevation={3} className={classes.paper}>
                <Grid container spacing={1} direction="column">
                    ...
                    <Grid container className={classes.rowSpacing} direction="column" spacing={4} justify="center" alignItems="center">
                        <Grid item xs={3}>
                            <GenericDatePicker idSelector='txtFechaValor' labelSelector='Fecha Valor' required={true} selectedDate={selectedDate} onChange={handleDateChange}/>
                        </Grid>
                        <Grid item xs={4}>
                            <FormControl component="fieldset">
                                <GenericTextInput label='Nombre de Archivo' idCampo='txtNomArch' required={true} defaultVal=''/>
                            </FormControl>
                        </Grid>
                    </Grid>
