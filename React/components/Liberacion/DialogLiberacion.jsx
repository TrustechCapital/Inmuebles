...
export default function DialogAdquirientes(props){
    ...
    return(
        <CatalogDialog opened={props.opened} operacionCatalogo={mode} nombreCatalogo="Liberacion" subtitle="Liberacion de Unidades" onCancel={props.handleClose} onAccept={handleAccept}>
