...
public class Auth {
	...
	public Auth(File file, HttpServletRequest request, HttpServletResponse response)
		throws SettingsException, IOException, Error {
		this(file, null, request, response);
	}
	...
	public Auth(File file, KeyStoreSettings keyStoreSetting, HttpServletRequest request,
				HttpServletResponse response) throws SettingsException, IOException, Error {
		this(new SettingsBuilder().fromFile(new FileInputStream(file), keyStoreSetting).build(), request, response);
	}
