...
public class Saml2Settings {
	...
	private String clientDestinationURL = null;

	public final String getClientDestinationURL() {
		return clientDestinationURL;
	}

	public void setClientDestinationURL(String clientDestinationURL) {
		this.clientDestinationURL = clientDestinationURL;
	}
