...
if(reporte.hasData()==true)
  ...
  String anioApertura = apertura.substring(apertura.length()-4,apertura.length());
  String anioActual = reporte.getVtrStrDato4().substring(reporte.getVtrStrDato4().length()-4,reporte.getVtrStrDato4().length());
