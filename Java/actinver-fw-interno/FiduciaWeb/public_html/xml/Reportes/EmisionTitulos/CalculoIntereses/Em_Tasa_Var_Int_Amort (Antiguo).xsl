        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="10mm" font-size="7pt" text-align="justify">
              ...
              <fo:inline font-weight="bold"><xsl:value-of select="eaviNumSerie"/></fo:inline>, nos permitimos informarles el cálculo 
              de la tasa de rendimiento anual bruto por el periodo comprendido entre el 
              ...
              sobre el valor nominal de los mismos, así como el importe de intereses a liquidar por el periodo 
              <fo:inline font-weight="bold"><xsl:value-of select="eaviIdSecCalc"/></fo:inline>, del 
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecIniProx"/></fo:inline> al 
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinProx"/></fo:inline>, liquidables el día 
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecPagoSig"/></fo:inline> conforme a lo siguiente:
            </fo:block>
            
            <fo:block margin-top="10mm" font-size="7pt" font-weight="bold">I. TASA DE RENDIMIENTO BRUTO </fo:block>
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center" background-color="blue" color="white">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm"><fo:inline>INSTRUMENTO <xsl:value-of select="eaviInstrumento"/> DIAS</fo:inline></fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm"><fo:inline>EQUIV. A <xsl:value-of select="eaviPeriodicidadDias"/> DIAS</fo:inline></fo:block></fo:table-cell>
              ...
              <fo:table>
                ...
                <fo:table-body>
                  ...
                  <fo:table-row text-align="center">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block><fo:inline font-weight="bold"><xsl:value-of select="eaviFecIniProx"/> al <xsl:value-of select="eaviFecFinProx"/></fo:inline> </fo:block></fo:table-cell>
            ...
            <fo:block margin-top="10mm" font-size="7pt" font-weight="bold"><fo:inline>III. MONTO A AMORTIZAR Y NUEVO VALOR NOMINAL AJUSTADO A PARTIR DEL <xsl:value-of select="eaviFecFinProx"/></fo:inline></fo:block>
            <fo:block margin-top="5mm" font-size="7pt">
              <fo:table>
                <fo:table-column column-width="3cm"/>
                <fo:table-column column-width="2cm"/>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center">
                    <fo:table-cell border="1pt solid black" background-color="blue" color="white"><fo:block margin-top="1.5mm">VALOR NOMINAL EMISION / ANTERIOR</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue" color="white"><fo:block margin-top="1.5mm">No. AMORT</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue" color="white"><fo:block margin-top="1.5mm">AMORTIZACION</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue" color="white"><fo:block margin-top="1.5mm">NUEVO VALOR NOMINAL AJUSTADO EMISION</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue" color="white"><fo:block margin-top="1.5mm">TOTAL DE TITULOS</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue" color="white"><fo:block margin-top="1.5mm">VNA X TITULO</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row text-align="center">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block><fo:inline font-weight="bold"><xsl:value-of select="eaviNumAmort"/> al <xsl:value-of select="eaviFecFinProx"/></fo:inline> </fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black"><fo:block><fo:inline font-weight="bold"><xsl:value-of select="eaviImpAmort"/></fo:inline> </fo:block></fo:table-cell>
