      ...
      <xsl:for-each select="QueryInfo/RowInfo">
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="2cm" font-size="9pt" text-align="justify">
              ...
              <fo:inline font-weight="bold"><xsl:value-of select="eaviNumSerie"/></fo:inline>, nos permitimos informarle los intereses devengados a pagar por el periodo 
              ...
              <xsl:value-of select="eaviFecFinPeriodo"/></fo:inline>,liquidable el <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinPeriodo"/></fo:inline> 
            </fo:block>
            ...
            <fo:table>
              ...
              <fo:table-body>
                <fo:table-row>
                  <fo:table-cell><fo:block margin-top="0" font-size="9pt" font-weight="bold">DATOS GENERALES DE LA EMISIÓN:</fo:block></fo:table-cell>
                </fo:table-row>
                <fo:table-row>
                  <fo:table-cell>
            ...
            <fo:block margin-top="1cm" font-size="7pt" font-weight="bold">I. INTERESES DEVENGADOS A PAGAR</fo:block>
