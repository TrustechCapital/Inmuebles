        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="10mm" font-size="7pt" text-align="justify">
              ...
              <fo:inline font-weight="bold"><xsl:value-of select="eaviNumSerie"/></fo:inline>, nos permitimos informarle el monto de los intereses que 
              devengaron los Certificados por el periodo comprendido del <fo:inline font-weight="bold"><xsl:value-of select="eaviFecIniPeriodo"/></fo:inline> al
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center" background-color="blue" color="white">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">VALOR NOMINAL EMISION</fo:block></fo:table-cell>
                  ...
                  <fo:table-row text-align="center">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block><fo:inline font-weight="bold"><xsl:value-of select="eaviImpInteresesConv"/></fo:inline> </fo:block></fo:table-cell>
            ...
            <fo:block margin-top="10mm" font-size="7pt" font-weight="bold">
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center">
                    ...
                    <fo:table-cell border="1pt solid black" number-columns-spanned="2" background-color="blue" color="white"><fo:block margin-top="1.5mm">VALOR NOMINAL AJUSTADO EMISION</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row text-align="center" background-color="blue" color="white">
