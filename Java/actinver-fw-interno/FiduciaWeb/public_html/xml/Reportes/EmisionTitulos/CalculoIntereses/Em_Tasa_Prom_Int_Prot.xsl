        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center" background-color="blue" color="white">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm"><fo:inline><xsl:value-of select="eaviInstrumento"/> PROMEDIO</fo:inline></fo:block></fo:table-cell>
            ...
            <fo:block margin-top="7mm" font-size="7pt" font-weight="bold">
              <fo:inline>II. PROTECCION VS INFLACION <xsl:value-of select="eaviFecFinProx"/></fo:inline>
            </fo:block>
            ...
            <fo:block margin-top="4mm" font-size="7pt">
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center">
                    <fo:table-cell border="1pt solid black" background-color="blue" color="white"><fo:block margin-top="1.5mm"><fo:inline>UDI INICIO <xsl:value-of select="eaviFecIniProx"/></fo:inline></fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue" color="white"><fo:block margin-top="1.5mm"><fo:inline>UDI VENCIMIENTO <xsl:value-of select="eaviFecFinProx"/></fo:inline></fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue" color="white"><fo:block margin-top="1.5mm">PRIMA</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row text-align="center">
