        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block text-align="center" margin-top="10mm" font-size="13pt">
              <fo:inline font-weight="bold"><xsl:value-of select="eaviCvePizarra"/> <xsl:value-of select="eaviNumSerie"/></fo:inline>
            </fo:block>
            ...
            correspondiente del <fo:inline font-weight="bold"><xsl:value-of select="eaviFecIniProx"/> al <xsl:value-of select="eaviFecFinProx"/></fo:inline>, 
            será del <fo:inline font-weight="bold"><xsl:value-of select="eaviTasaBruta"/></fo:inline> anual 
            sobre el valor nominal de los mismos, de acuerdo con las disposiciones fiscales vigentes.
            </fo:block>
            ...
            pagarán los intereses por un monto de <fo:inline font-weight="bold"><xsl:value-of select="eaviImpIntereses"/></fo:inline> MXN correspondientes al periodo No. 
            ...
            a razón de una tasa bruta anual del <fo:inline font-weight="bold"><xsl:value-of select="eaviTasaBruta"/></fo:inline>.
            </fo:block>
