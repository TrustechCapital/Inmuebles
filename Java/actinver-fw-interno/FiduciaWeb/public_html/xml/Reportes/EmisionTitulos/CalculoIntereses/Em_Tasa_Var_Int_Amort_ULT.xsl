        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="10mm" font-size="9pt" text-align="justify">
              ...
              <fo:inline font-weight="bold"><xsl:value-of select="eaviNumSerie"/></fo:inline>, nos permitimos informarle la tasa de rendimiento bruto anual que 
              devengarón los Certificados Bursátiles, por el periodo <fo:inline font-weight="bold"><xsl:value-of select="eaviIdSecCalc"/></fo:inline>, comprendido del 
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecIniPeriodo"/></fo:inline> al <fo:inline font-weight="bold">
              <xsl:value-of select="eaviFecFinPeriodo"/></fo:inline> sobre el valor nominal de los mismos, su procedimiento de cálculo y el importe de la amortización, 
              liquidable el dia <fo:inline font-weight="bold"><xsl:value-of select="eaviFecPago"/></fo:inline>.
            </fo:block>
            
            <fo:block margin-top="5mm" font-size="7pt" font-weight="bold">I. INTERESES DEVENGADOS A PAGAR</fo:block>
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center" background-color="blue" color="white">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">TASA DE INTERES BRUTO</fo:block></fo:table-cell>
            ...
            <fo:block margin-top="5mm" font-size="7pt" font-weight="bold">II. AMORTIZACION</fo:block>
            <fo:block margin-top="5mm" font-size="7pt">
              <fo:table>
                <fo:table-column column-width="3.5cm"/>
                <fo:table-column column-width="3.5cm"/>
            ...
            <fo:block margin-top="3cm" font-size="7pt" text-align="center">
            ...
            <fo:block margin-top="3cm" font-size="7pt">
              <fo:table>
                <fo:table-column column-width="7cm"/>
