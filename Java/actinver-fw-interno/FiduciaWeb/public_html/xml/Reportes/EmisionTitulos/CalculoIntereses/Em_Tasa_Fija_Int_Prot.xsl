        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="10mm" font-size="9pt" text-align="justify">
              ...
              <fo:inline font-weight="bold"><xsl:value-of select="eaviNumSerie"/></fo:inline>, nos permitimos informarles la tasa de interés bruto anual que devengarán 
              los Certificados por el periodo del <fo:inline font-weight="bold"><xsl:value-of select="eaviFecIniProx"/></fo:inline> al
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinProx"/></fo:inline>, sobre el valor nominal de los mismos, su procedimiento de cálculo y el
              importe de los intereses devengados a pagar por el perido <fo:inline font-weight="bold"><xsl:value-of select="eaviIdSecCalc"/></fo:inline> comprendido del
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecIniPeriodo"/></fo:inline> al <fo:inline font-weight="bold">
              <xsl:value-of select="eaviFecFinPeriodo"/></fo:inline>,liquidables el <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinPeriodo"/></fo:inline> 
            </fo:block>
            
            <fo:block margin-top="10mm" font-size="7pt" font-weight="bold">I. TASA DE INTERES BRUTO</fo:block>
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center" background-color="blue" color="white">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">INSTRUMENTO TASA BASE</fo:block></fo:table-cell>
            ...
            <fo:block margin-top="10mm" font-size="7pt" font-weight="bold">III. PROTECCION VS INFLACION</fo:block>
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center" color="white">
                    <fo:table-cell border="1pt solid black" background-color="blue"><fo:block margin-top="1.5mm">UDI INICIO</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue"><fo:block margin-top="1.5mm">UDI VENCIMIENTO</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue"><fo:block margin-top="1.5mm">PRIMA</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue"><fo:block margin-top="1.5mm">FECHA DE PAGO</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row text-align="center">
            ...
            <fo:block margin-top="30mm" font-size="7pt" text-align="center">
              <fo:inline font-weight="bold">A t e n t a m e n t e</fo:inline>
            </fo:block>
            <fo:block margin-top="3mm" font-size="9pt" text-align="center">
              <fo:inline font-weight="bold">REPRESENTANTE COMUN DE LOS TENEDORES</fo:inline>
            </fo:block>
            <fo:block margin-top="3mm" font-size="11pt" text-align="center" font-weight="bold">
              <fo:inline font-weight="bold">nacional financiera</fo:inline>
            </fo:block>
            <fo:block margin-top="3mm" font-size="9pt" text-align="center" font-weight="bold">
