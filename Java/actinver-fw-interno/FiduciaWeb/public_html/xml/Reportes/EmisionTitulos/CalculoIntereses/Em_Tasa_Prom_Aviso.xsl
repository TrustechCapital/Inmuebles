        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            <fo:block margin-top="1cm" text-align="center" font-weight="bold" font-size="10px">
              <fo:inline font-weight="bold">AVISO A LOS TENEDORES DE CERTIFICADOS BURSÁTILES EMITIDOS POR <xsl:value-of select="eaviNomEmisor"/></fo:inline>
            </fo:block>
            ...
            hacemos de su conocimiento que la tasa de rendimiento bruto que devengarán los Certificados Bursátiles de 
            ...
            número <fo:inline font-weight="bold"><xsl:value-of select="eaviIdSecCalc"/></fo:inline> correspondiente del 
            ...
            <fo:inline font-weight="bold"><xsl:value-of select="eaviPeriodoAnterior"/></fo:inline>
