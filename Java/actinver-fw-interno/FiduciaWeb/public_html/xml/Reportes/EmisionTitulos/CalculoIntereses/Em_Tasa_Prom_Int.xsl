        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="10mm" font-size="7pt" text-align="justify">
              ...
              <fo:inline font-weight="bold"><xsl:value-of select="eaviNumSerie"/></fo:inline>, nos permitimos informarle la tasa de rendimiento 
              bruto anual que devengan los Certificados por el periodo 
              <fo:inline font-weight="bold"><xsl:value-of select="eaviIdSecCalc"/></fo:inline> comprendido del
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecIniPeriodo"/></fo:inline> al
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinPeriodo"/></fo:inline> sobre el valor nominal de los mismos, su 
              prodecimiento de cálculo y el importe de los intereses a pagar, liquidable el 
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinProx"/></fo:inline>
            </fo:block>
            
            <fo:block margin-top="10mm" font-size="7pt" text-align="justify">
              Instrumento: TPFB, se consideraron las tasas de Fondeo Bancario Promedio Ponderadas dadas a conocer por Banco de México del
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecIniPeriodo"/></fo:inline>, con clave de pizarra 
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center" background-color="blue" color="white">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">TPFB PROMEDIO</fo:block></fo:table-cell>
            ...
            <fo:block text-align="center" margin-top="25mm" font-size="9pt">Atentamente</fo:block>
