        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="10mm" font-size="9pt" text-align="justify">
              ...
              <fo:inline font-weight="bold"><xsl:value-of select="eaviNumSerie"/></fo:inline>, nos permitimos informarle la tasa de rendimiento bruto anual 
                        ...
                        <fo:table margin-top="2mm" margin-bottom="2mm" margin-left="2mm" margin-right="2mm">
                          ...
                          <fo:table-body>
                            <fo:table-row>
                              ...
                              <fo:table-cell><fo:block>VNA EMISIÓN ANTERIOR: </fo:block></fo:table-cell>
                              <fo:table-cell><fo:block><xsl:value-of select="eaviImpValNominal"/></fo:block></fo:table-cell>
                            </fo:table-row>
                            <fo:table-row>
            ...
            <fo:block margin-top="5mm" font-size="7pt" font-weight="bold">I. TASA DE RENDIMIENTO BRUTO</fo:block>
            ...
            <fo:block margin-top="5mm" font-size="7pt" font-weight="bold">III. MONTO A AMORTIZAR Y NUEVO VALOR NOMINAL AJUSTADO A PARTIR DEL: <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinProx"/></fo:inline></fo:block>
            <fo:block margin-top="5mm" font-size="7pt">
              <fo:table>
                <fo:table-column column-width="2.5cm"/>
                <fo:table-column column-width="2.5cm"/>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center" color="white">
                    <fo:table-cell border="1pt solid black" background-color="blue"><fo:block margin-top="1.5mm">VALOR NOMINAL EMISION ANTERIOR</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue"><fo:block margin-top="1.5mm">No. AMORTIZACION</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue"><fo:block margin-top="1.5mm">AMORTIZACION</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue"><fo:block margin-top="1.5mm">NUEVO VALOR NOMINAL AJUSTADO EMISION</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue"><fo:block margin-top="1.5mm">TOTAL DE TITULOS</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black" background-color="blue"><fo:block margin-top="1.5mm">VNA X TITULO</fo:block></fo:table-cell>
                  ...
                  <fo:table-row text-align="center">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block><fo:inline font-weight="bold"><xsl:value-of select="format-number(number(eaviImpValNomTot)+number(eaviImpAmortizacion),'.00')"/></fo:inline></fo:block></fo:table-cell>
