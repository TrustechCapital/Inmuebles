        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="10mm" font-size="7pt" text-align="justify">
              ...
              <fo:inline font-weight="bold"><xsl:value-of select="eaviNumSerie"/></fo:inline>, nos permitimos informarles el monto de intereses que devengaron 
              los Certificados por el periodo comprendido del <fo:inline font-weight="bold"><xsl:value-of select="eaviFecIniPeriodo"/></fo:inline> al
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinPeriodo"/></fo:inline>, así como el valor nominal ajustado y el monto de 
              amortización anticipada, liquidable el <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinProx"/></fo:inline>.
            </fo:block>
            
            <fo:block margin-top="10mm" font-size="7pt" font-weight="bold">I. INTERESES DEVENGADOS A PAGAR </fo:block>
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center">
                    ...
                    <fo:table-cell><fo:block></fo:block></fo:table-cell>
                    <fo:table-cell><fo:block></fo:block></fo:table-cell>
                    <fo:table-cell number-columns-spanned="2" border="1pt solid black" background-color="blue" color="white"><fo:block margin-top="1.5mm">INTERESES</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block></fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row text-align="center" background-color="blue" color="white">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">VALOR NOMINAL EMISION UDIS</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">UDI</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">INTERESES UDI</fo:block></fo:table-cell>
                  ...
                  <fo:table-row text-align="center">
                    ...
                    <fo:table-cell border="1pt solid black"><fo:block><fo:inline font-weight="bold"><xsl:value-of select="eaviTipoCambio"/></fo:inline> </fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black"><fo:block><fo:inline font-weight="bold"><xsl:value-of select="eaviInteresesConv"/></fo:inline> </fo:block></fo:table-cell>
            ...
            <fo:block margin-top="10mm" font-size="7pt" font-weight="bold">II. MONTO A AMORTIZAR Y NUEVO VALOR NOMINAL AJUSTADO A PARTIR DEL 
              <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinProx"/></fo:inline>
            </fo:block>
            ...
            <fo:block margin-top="5mm" font-size="7pt">
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row text-align="center" background-color="blue" color="white">
                    <fo:table-cell number-columns-spanned="2" border="1pt solid black"><fo:block margin-top="1.5mm">AMORTIZACION</fo:block></fo:table-cell>
                    <fo:table-cell number-columns-spanned="4" border="1pt solid black"><fo:block margin-top="1.5mm">VALOR NOMINAL AJUSTADO EMISION</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row text-align="center" background-color="blue" color="white">
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">MONTO A AMORTIZAR</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">MONTO A AMORTIZAR UDIS</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">VNAjustado $</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">VNAjustado UDIS</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">VNA X TITULO $</fo:block></fo:table-cell>
                    <fo:table-cell border="1pt solid black"><fo:block margin-top="1.5mm">VNA X TITULO UDIS</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row text-align="center">
                    <fo:table-cell border="1pt solid black"><fo:block><fo:inline font-weight="bold"><xsl:value-of select="eaviAmortConv"/></fo:inline> </fo:block></fo:table-cell>
