        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="10mm" font-size="9pt" text-align="justify">
              ...
              <fo:inline font-weight="bold"><xsl:value-of select="eaviNumSerie"/></fo:inline>, nos permitimos informarles la tasa de rendimiento bruto anual que 
              devengarán los Certificados sobre el valor nominal de los mismos, su procedimiento de cálculo y el importe de los intereses devengados a pagar,
              liquidables el <fo:inline font-weight="bold"><xsl:value-of select="eaviFecFinProx"/></fo:inline> 
            </fo:block>
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block margin-top="5mm" font-size="9pt" font-weight="bold">DATOS GENERALES DE LA EMISIÓN:</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row>
                    <fo:table-cell>
