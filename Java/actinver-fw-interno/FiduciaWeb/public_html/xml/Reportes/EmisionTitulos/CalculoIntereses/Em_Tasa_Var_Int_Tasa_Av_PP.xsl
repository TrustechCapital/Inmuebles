          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="5mm">
              ...
              <fo:block margin-top="10mm" font-size="9pt" text-align="justify">
                ...
                <xsl:value-of select="eaviFecFinPeriodo"/></fo:inline>, liquidable al día 
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block margin-top="10mm" font-size="9pt" font-weight="bold">DATOS GENERALES DE LA EMISIÓN:</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row>
                    <fo:table-cell>
            ...
            <fo:block margin-top="30mm" font-size="9pt">
              <fo:table>
                <fo:table-column column-width="7cm"/>
