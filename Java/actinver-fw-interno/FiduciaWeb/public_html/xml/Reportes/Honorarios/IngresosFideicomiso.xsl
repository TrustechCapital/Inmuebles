              ...
              <fo:table background-color="rgb(188,200,192)" > <!--259 -->
                ...
                <fo:table-body>                
                  ...
                  <fo:table-row>
                    ...
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Programado</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                    ...
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Programado Anual</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                ...
                <fo:table-body>
                  ...
                  <xsl:for-each select="ReportInfo/QueryInfo/RowInfo">      
                    ...
                    <fo:table-row>
                      ...
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(presanual),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(presupuesto),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                  ...
                  <fo:table-row>
                    <fo:table-cell text-align="right" number-columns-spanned="10">
                  ...
                  <fo:table-row>
                    ...
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/presanual), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/presupuesto), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
