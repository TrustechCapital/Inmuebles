        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="5mm" font-size="7pt">
              Mediante aviso de cobro de fecha y primer recordatoriio de fechas 
              <fo:inline font-weight="bold"><xsl:value-of select="ravFechaAviso"/></fo:inline>
              <fo:inline font-weight="bold"><xsl:value-of select="ravFechaPri"/></fo:inline>le solicitamos el pago de los honorarios fiduciarios por la administración del Fideicomiso 
              <fo:inline font-weight="bold"><xsl:value-of select="ravNumContrato"/></fo:inline>
              <fo:inline font-weight="bold"><xsl:value-of select="ravNomContrato"/></fo:inline> correspondientes al período 
              <fo:inline font-weight="bold"><xsl:value-of select="ravPeriodoAdeudo"/></fo:inline> por un importe de $
              <fo:inline font-weight="bold"><xsl:value-of select="ravImporte60"/></fo:inline> IVA incluido. 
            </fo:block>
            <fo:block margin-top="5mm" font-size="7pt">En virtud de que a la fecha no nos han sido cubiertos los citados honorarios y que venció el cumplimiento de la obligación de pago reflejando una antigüedad de 60 días y que adicionalmente vencen los correspondientes al periodo 
              <fo:inline font-weight="bold"><xsl:value-of select="ravPeriodo"/></fo:inline> por un importe de $
              <fo:inline font-weight="bold"><xsl:value-of select="ravImportePer"/></fo:inline> IVA incluido, me permito solicitar que a la brevedad posible se nos liquide el adeudo total.
            </fo:block>
            <fo:block margin-top="5mm" font-size="7pt">El pago lo podrá realizar mediante deposito en la cuenta cuyos datos a continuación se citan:</fo:block>  
