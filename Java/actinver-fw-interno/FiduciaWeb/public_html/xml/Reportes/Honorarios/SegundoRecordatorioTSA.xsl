      ...
      <xsl:for-each select="QueryInfo/RowInfo">      
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="5mm" font-size="7pt">En virtud de que a la fecha no nos han sido cubiertos los citados honorarios, me permito solicitar que a la brevedad posible se nos liquide el adeudo total ya que venció el cumplimiento de la obligación de pago reflejando una antigüedad de 60 días.
            </fo:block>
