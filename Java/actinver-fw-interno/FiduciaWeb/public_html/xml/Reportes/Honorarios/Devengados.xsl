    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format"
      ...
      <fo:layout-master-set>
        ...
        <fo:simple-page-master master-name="hojaCartaHorizontal" page-width="279mm"
          ...
          <fo:region-body region-name="xsl-region-body" margin-top="35mm" margin-bottom="15mm"/>
          <fo:region-before extent="50mm" region-name="xsl-region-header"/>
              ...
              <fo:table background-color="rgb(188,200,192)" > <!--259 -->
                ...
                <fo:table-body>                
                  <fo:table-row>
                    ...
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Acumulado en Cartera</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">30 Dias</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">60 Dias</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">90 Dias</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Mas de 90 dias Ejercicio Actual</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Mas de 90 dias Ejercicios Anteriores</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
            ...
            <fo:block>
              ...
              <fo:table>
                ...
                <fo:table-body>
                  ...
                  <xsl:for-each select="ReportInfo/QueryInfo/RowInfo">      
                    ...
                    <fo:table-row>
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="cveNumContrato"/>&nbsp;&nbsp;&nbsp;</fo:block>
                      </fo:table-cell>
                      <fo:table-cell text-align="left">
                        <fo:block font-size="7px"><xsl:value-of select="cveNomContrato"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(cveAcumulado),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(cveVenc30),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(cveVenc60),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(cveVenc90),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(cveVencM90Ejeact),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(cveVencM90Ejeant),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(total),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                    </fo:table-row>
                  ...
                  <fo:table-row>
                    <fo:table-cell text-align="right" number-columns-spanned="9">
                      <fo:block font-size="7px">&nbsp;</fo:block>
                    </fo:table-cell>
                  </fo:table-row>                  
                  <fo:table-row>
                    <fo:table-cell text-align="right" number-columns-spanned="2">
                      <fo:block font-size="7px" font-weight="bold">Total:&nbsp;&nbsp;&nbsp;</fo:block>
                    </fo:table-cell>
                    <fo:table-cell text-align="right">
                      <fo:block font-size="7px" font-weight="bold"><xsl:value-of select="format-number(number(ReportInfo/QueryInfo/TotalesInfo/cveAcumulado),'#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="7px" font-weight="bold"><xsl:value-of select="format-number(number(ReportInfo/QueryInfo/TotalesInfo/cveVenc30),'#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="7px" font-weight="bold"><xsl:value-of select="format-number(number(ReportInfo/QueryInfo/TotalesInfo/cveVenc60),'#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="7px" font-weight="bold"><xsl:value-of select="format-number(number(ReportInfo/QueryInfo/TotalesInfo/cveVenc90),'#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="7px" font-weight="bold"><xsl:value-of select="format-number(number(ReportInfo/QueryInfo/TotalesInfo/cveVencM90Ejeact),'#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="7px" font-weight="bold"><xsl:value-of select="format-number(number(ReportInfo/QueryInfo/TotalesInfo/cveVencM90Ejeant),'#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="7px" font-weight="bold"><xsl:value-of select="format-number(number(ReportInfo/QueryInfo/TotalesInfo/total),'#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                  </fo:table-row>                  
