              ...
              <fo:table>
                ...
                <fo:table-body>
                  ...
                  <xsl:for-each select="ReportInfo/QueryInfo/RowInfo">      
                    ...
                    <fo:table-row>
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="rhoNumContrato"/>&nbsp;&nbsp;&nbsp;</fo:block>
                      </fo:table-cell>
                      <fo:table-cell text-align="left">
                        <fo:block font-size="7px"><xsl:value-of select="rhoNomContrato"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(rhoDevMensual),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(rhoPagMensual),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(rhoTotMensual),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(rhoDevAcumulado),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(rhoPagAcumulado),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(rhoTotAcumulado),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                    </fo:table-row>
                  ...
                  <fo:table-row>
                    ...
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/rhoDevMensual), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/rhoPagMensual), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/rhoTotMensual), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/rhoDevAcumulado), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/rhoPagAcumulado), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/rhoTotAcumulado), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                  </fo:table-row>                  
