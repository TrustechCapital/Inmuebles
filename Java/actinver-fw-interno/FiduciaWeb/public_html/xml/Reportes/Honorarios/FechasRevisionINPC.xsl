    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format"
      ...
      <fo:layout-master-set>
        ...
        <fo:simple-page-master master-name="hojaCartaHorizontal" page-width="279mm"
          ...
          <fo:region-body region-name="xsl-region-body" margin-top="36mm" margin-bottom="15mm"/>
          <fo:region-before extent="50mm" region-name="xsl-region-header"/>
              ...
              <fo:table background-color="rgb(188,200,192)" > <!--259 -->
                ...
                <fo:table-body>                
                  <fo:table-row>
                    ...
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Dia Ult. Rev.</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Mes Ult. Rev.</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Año Ult. Rev.</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Periodicidad</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">INPC Autom.</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Estatus</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Comentarios</fo:block>
                    </fo:table-cell>                  
                  </fo:table-row>
                </fo:table-body>
              </fo:table>                   
                  ...
                  <xsl:for-each select="ReportInfo/QueryInfo/RowInfo">      
                    ...
                    <fo:table-row>
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="rinNumContrato"/>&nbsp;&nbsp;&nbsp;</fo:block>
                      </fo:table-cell>
                      <fo:table-cell text-align="left">
                        <fo:block font-size="7px"><xsl:value-of select="rinNomContrato"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="center">
                        <fo:block font-size="7px"><xsl:value-of select="rinDia"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="center">
                        <fo:block font-size="7px"><xsl:value-of select="rinMes"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="center">
                        <fo:block font-size="7px"><xsl:value-of select="rinAno"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="left">
                        <fo:block font-size="7px"><xsl:value-of select="rinPeriodicidad"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="center">
                        <fo:block font-size="7px"><xsl:value-of select="rinCalcAutomatico"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="left">
                        <fo:block font-size="7px"><xsl:value-of select="rinStatus"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="left">
                        <fo:block font-size="7px"><xsl:value-of select="rinComentarios"/></fo:block>
                      </fo:table-cell>                  
                    </fo:table-row>
