        ...
        <fo:page-sequence master-reference="hojaCarta">
          ...
          <fo:flow flow-name="xsl-region-body">
            ...
            <fo:block margin-top="5mm" font-size="7pt">
              Mediante aviso de cobro de fecha <fo:inline font-weight="bold"><xsl:value-of select="ravFechaAviso"/></fo:inline> le solicitamos el pago de los honorarios fiduciarios por la administración del Fideicomiso 
              ...
              <fo:inline font-weight="bold"><xsl:value-of select="ravImporte30"/></fo:inline> IVA incluido. 
            </fo:block>
            <fo:block margin-top="5mm" font-size="7pt">En virtud de que a la fecha no nos han sido cubiertos los citados honorarios y que adicionalmente vencen  los correspondientes al período
            ...
            <fo:block margin-top="5mm" font-size="7pt">Mediante deposito en la cuenta cuyos datos a continuación se citan:</fo:block>  
