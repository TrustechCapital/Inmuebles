              ...
              <fo:table background-color="rgb(188,200,192)" > <!--259 -->
                ...
                <fo:table-body>                
                  <fo:table-row>
                    ...
                    <fo:table-cell text-align="center" number-columns-spanned="2">
                      <fo:block font-size="7px" font-weight="bold" background-color="rgb(188,200,192)">Periodo</fo:block>
                    </fo:table-cell>                  
                  </fo:table-row>                
                  <fo:table-row>
                    <fo:table-cell text-align="center">
                    ...
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Año</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Ente</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                    ...
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Saldo</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
              ...
              <fo:table>
                ...
                <fo:table-body>
                  ...
                  <xsl:for-each select="ReportInfo/QueryInfo/RowInfo">      
                    ...
                    <fo:table-row>
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="eanNumContrato"/>&nbsp;&nbsp;&nbsp;</fo:block>
                      </fo:table-cell>
                      <fo:table-cell text-align="left">
                        <fo:block font-size="7px"><xsl:value-of select="eanNomContrato"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="center">
                        <fo:block font-size="7px"><xsl:value-of select="eanAno"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="center">
                        <fo:block font-size="7px"><xsl:value-of select="eanEnte"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(eanDevengado),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(eanPagado),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(eanTotal),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="eanPerDel"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="eanPerAl"/></fo:block>
                      </fo:table-cell>                  
                    </fo:table-row>
                  ...
                  <fo:table-row>
                    ...
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/eanDevengado), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/eanPagado), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/eanTotal), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold" number-columns-spanned="2">&nbsp;</fo:block>
                    </fo:table-cell>                  
                  </fo:table-row>                  
