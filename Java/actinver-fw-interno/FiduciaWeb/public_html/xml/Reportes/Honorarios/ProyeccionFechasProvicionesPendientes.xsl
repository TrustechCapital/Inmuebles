              ...
              <fo:table background-color="rgb(188,200,192)" > <!--259 -->
                ...
                <fo:table-body>                
                  <fo:table-row>
                    ...
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Fecha de Calculo</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Del</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Al</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Importe Original</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Importe Pagado</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Imp. Total</fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="center">
                      <fo:block font-size="7px">Persona a quien se le Cobra</fo:block>
                    </fo:table-cell>                  
                  </fo:table-row>
                </fo:table-body>
              </fo:table>                   
                ...
                <fo:table-body>
                  ...
                  <xsl:for-each select="ReportInfo/QueryInfo/RowInfo">      
                    ...
                    <fo:table-row>
                      ...
                      <fo:table-cell text-align="center">
                        <fo:block font-size="7px"><xsl:value-of select="proFecCalcHono"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="center">
                        <fo:block font-size="7px"><xsl:value-of select="proDiaPerDel"/>/<xsl:value-of select="proMesPerDel"/>/<xsl:value-of select="proAnoPerDel"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="center">
                        <fo:block font-size="7px"><xsl:value-of select="proDiaPerAl"/>/<xsl:value-of select="proMesPerAl"/>/<xsl:value-of select="proAnoPerAl"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(proImporte),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(proIva),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="format-number(number(proTotal),'#,##0.00')"/></fo:block>
                      </fo:table-cell>                  
                      <fo:table-cell text-align="right">
                        <fo:block font-size="7px"><xsl:value-of select="pacCvePersCob"/></fo:block>
                      </fo:table-cell>                  
                    </fo:table-row>
                  ...
                  <fo:table-row>
                    ...
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/proImporte), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/proIva), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold"><xsl:value-of select="format-number(sum(ReportInfo/QueryInfo/RowInfo/proTotal), '#,##0.00')"/></fo:block>
                    </fo:table-cell>                  
                    <fo:table-cell text-align="right">
                      <fo:block font-size="8px" font-weight="bold">&nbsp;</fo:block>
                    </fo:table-cell>                  
                  </fo:table-row>                  
