      ...
      <xsl:for-each select="QueryInfo/RowInfo">      
        <fo:page-sequence master-reference="hojaCarta">
          <fo:static-content flow-name="xsl-region-header">
            ...
            <fo:block margin-top="0.3cm" text-align="center" border="1pt solid black" font-size="7pt" font-weight="bold" line-height="10pt" background-color="silver">
              <fo:table>
                <fo:table-column column-width="19.1cm"/>
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block><fo:inline font-style="italic">FICHA ÚNICA DE OPERACIÓN FIDUCIARIA</fo:inline></fo:block></fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
            </fo:block>
          ...
          <fo:flow flow-name="xsl-region-body">
              ...
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row>
                    ...
                    <fo:table-cell><fo:block font-size="6pt" margin-left="0.2cm" border="1pt solid black">&#160;<xsl:value-of select="ctoNumContrato"/></fo:block></fo:table-cell>
                    <fo:table-cell><fo:block  font-size="4pt" text-align="center">Nombre:</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block font-size="6pt" margin-left="0.2cm" border="1pt solid black">&#160;<xsl:value-of select="ctoNomContrato"/></fo:block></fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
            </fo:block>
            <fo:block margin-top="0.4cm" font-size="4pt" font-weight="bold">OPERACIÓN SOLICITADA</fo:block>
            <fo:block margin-top="0.4cm" font-size="4pt">
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block margin-left="0.2cm" space-before="0.2cm" font-size="4pt">RETIRO</fo:block></fo:table-cell>
                    <fo:table-cell height="0.4cm"><fo:block text-align="center" font-size="8pt" border="1pt solid black" font-weight="bold">&#160;
                      <fo:inline><xsl:value-of select="retiro"></xsl:value-of></fo:inline>
                    ...
                    <fo:table-cell height="0.4cm"><fo:block text-align="center" font-size="8pt" border="1pt solid black" font-weight="bold">&#160;
                      <fo:inline><xsl:value-of select="deposito"></xsl:value-of></fo:inline>
                    </fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="left" font-size="4pt"></fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="left" space-before="0.2cm" font-size="4pt">TRASPASO</fo:block></fo:table-cell>
                    <fo:table-cell height="0.4cm"><fo:block text-align="center" font-size="8pt" border="1pt solid black" font-weight="bold">&#160;
                      <fo:inline><xsl:value-of select="traspaso"></xsl:value-of></fo:inline>
                    </fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="left" font-size="4pt"></fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="left" space-before="0.2cm" font-size="4pt">PAGO DE HONORARIOS</fo:block></fo:table-cell>
                    <fo:table-cell height="0.4cm"><fo:block text-align="center" font-size="8pt" border="1pt solid black" font-weight="bold">&#160;
                      <fo:inline><xsl:value-of select="pago"></xsl:value-of></fo:inline>
                    </fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="left" font-size="4pt"></fo:block></fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
            ...
            <fo:block margin-top="0.5cm" font-size="4pt">
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt">DEL CONTRATO</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt"></fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt">AL CONTRATO</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt"></fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt">ESTATUS DE LA INSTRUCCIÓN</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt"></fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt">PERIODO QUE PAGA</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row>
                    <fo:table-cell height="0.8cm"><fo:block text-align="center" font-size="7pt" border="1pt solid black">&#160;
                      <fo:inline><xsl:value-of select="delContrato"></xsl:value-of></fo:inline>
                    </fo:block></fo:table-cell>
                    <fo:table-cell><fo:block></fo:block></fo:table-cell>
                    <fo:table-cell height="0.8cm"><fo:block text-align="center" font-size="7pt" border="1pt solid black">&#160;
                      <fo:inline><xsl:value-of select="alContrato"></xsl:value-of></fo:inline>
                    </fo:block></fo:table-cell>
                    <fo:table-cell><fo:block></fo:block></fo:table-cell>
                    <fo:table-cell height="0.6cm"><fo:block text-align="center" font-size="7pt" border="1pt solid black">&#160;
                      <fo:inline><xsl:value-of select="statusInstruc"></xsl:value-of></fo:inline>
                    </fo:block></fo:table-cell>
                    <fo:table-cell><fo:block></fo:block></fo:table-cell>
                    <fo:table-cell height="0.8cm"><fo:block text-align="center" font-size="7pt" border="1pt solid black">&#160;
                      <fo:inline><xsl:value-of select="periodoPaga"></xsl:value-of></fo:inline>
                    </fo:block></fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
            ...
            <fo:block margin-top="0.5cm" font-size="4pt">
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt">INSTRUMENTO</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt"></fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt">INSTRUMENTO</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt"></fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt">ESTATUS CONTABILIDAD</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt"></fo:block></fo:table-cell>
                    <fo:table-cell><fo:block text-align="center" font-size="4pt">FACTURA QUE PAGA</fo:block></fo:table-cell>
                  </fo:table-row>
                  <fo:table-row>
                    <fo:table-cell height="0.8cm"><fo:block text-align="center" font-size="7pt" border="1pt solid black">&#160;
                      <fo:inline><xsl:value-of select="instrumento"></xsl:value-of></fo:inline>
                    </fo:block></fo:table-cell>
                    <fo:table-cell><fo:block></fo:block></fo:table-cell>
                    <fo:table-cell height="0.8cm"><fo:block text-align="center" font-size="7pt" border="1pt solid black">&#160;</fo:block></fo:table-cell>
                    <fo:table-cell><fo:block></fo:block></fo:table-cell>
                    <fo:table-cell height="0.8cm"><fo:block text-align="center" font-size="7pt" border="1pt solid black">&#160;
                      <fo:inline><xsl:value-of select="statusConta"></xsl:value-of></fo:inline>
                    </fo:block></fo:table-cell>
                    <fo:table-cell><fo:block></fo:block></fo:table-cell>
                    <fo:table-cell height="0.8cm"><fo:block text-align="center" font-size="7pt" border="1pt solid black">&#160;
                      <fo:inline><xsl:value-of select="factura"></xsl:value-of></fo:inline>
                    </fo:block></fo:table-cell>
                  </fo:table-row>
                </fo:table-body>
              </fo:table>
            ...
            <fo:block font-size="4pt">
              <fo:table>
                ...
                <fo:table-body>
                  <fo:table-row><fo:table-cell><fo:block font-size="4pt" text-align="center">IMPORTE TOTAL</fo:block></fo:table-cell></fo:table-row>
                  <fo:table-row><fo:table-cell height="0.8cm"><fo:block font-size="6pt" text-align="center" margin-top="0.2cm" border="1pt solid black">&#160;<xsl:value-of select="importe"/></fo:block></fo:table-cell></fo:table-row>
                </fo:table-body>
              </fo:table>
            </fo:block>
              ...
              <fo:table>
                ...
                <fo:table-body>
                  ...
                  <fo:table-row>
                    ...
                    <fo:table-cell number-columns-spanned="3"><fo:block margin-top="0.4cm" border="1pt solid black" padding-bottom="0.2cm">
                      <fo:block><fo:inline padding-left="0.2cm" font-size="3pt">OBSERVACIONES DE TESORERIA</fo:inline></fo:block>
                      <fo:block margin-top="0.4cm"><fo:inline padding-left="0.2cm"  font-size="5pt">&#160;<xsl:value-of select="detalleInstruc"/></fo:inline></fo:block>
                      <fo:block margin-top="0.4cm"><fo:inline padding-left="0.2cm"  font-size="5pt">&#160;hola<xsl:value-of select="formaHonorarios"/></fo:inline></fo:block>
                    </fo:block></fo:table-cell>
