<form name="frmDatosInterfase" id="frmDatosInterfase" onsubmit="">
    <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
        <tr>
            <td align="center" height="100%" class="titulo">Carga de Precios Valuaci&oacute;n</td>
        </tr>
        <tr>
            <td height="100%">&nbsp;&nbsp;</td>
        </tr>
                ...
                <table width="90%" align="center" class="texto">
                  ...
                  <tr valign="middle">
                    ...
                    <tr valign="middle">
                        ...
                        <td align="right" width="13%">Fecha Valor</td>
                        <td align="left" width="44%">
                            <input type="text" name="txtFechaValor" id="txtFechaValor" size="10" ref="conFecCon" fun="loadTxtElementX" thevalue="fecha" next="cmbTipoLiq"
                                   maxlength="10" tipo="Fecha" required="required" message="La Fecha Valor es un campo obligatorio" style="width:150px;"/>
                        </td>
        ...
        <tr>
          <td align="center">&nbsp;
            ...
            <input type="button" value="Vaciar Precios" name="cmdVaciar" id="cmdVaciar" class="boton" onclick="ejecutaStoreInterfase();"/>&nbsp;&nbsp;&nbsp;&nbsp;
