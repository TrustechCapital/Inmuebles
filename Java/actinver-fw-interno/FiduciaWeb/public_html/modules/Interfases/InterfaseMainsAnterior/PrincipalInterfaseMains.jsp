  ...
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
      ...
      <td height="100%">
        <table width="90%" align="center" class="texto">
          ...
          <tr valign="middle">
            ...
            <td align="right" width="3%">Interfase kyc</td>
            <td align="left" width="44%">
          ...
          <tr valign="middle">
            ...
            <td align="left" width="44%">
              <input type="radio" name="chkPeriodicidad" id="chk2" class="radio" onClick="GI('interfase').value=this.id.replace('chk','')" value="1"/>
            <!--<input type="file" id="txtRutaFile"/>-->
            </td>
            <td align="left" width="24%">&nbsp;</td>
          </tr>
    ...
    <tr>
      <td align="center">&nbsp;
        ...
        <input type="button" value="Limpiar" name="cmdLimpiar" id="cmdLimpiar" class="boton" onclick="onButtonClickPestania('Interfases.InterfaseMainsAnterior.PrincipalInterfaseMains','');"/>
      </td>
    </tr>
    ...
    <tr align="center">
                ...
                <table cellspacing="0" cellpadding="0" border="0">
                  ...
                  <div style="height:200px; overflow:auto; width:573px;">
                    <table id="tablaConceptosObligatoriosPendientes" border="0" cellspacing="0" cellpadding="0" dataInfo="tablaConceptosData" keys="" fun="" radioWidth="23" NoRecordsMsg="No existen Registros para estos criterios de b&uacute;squeda"/>
                  </div>
                </td>
              </tr>
  </table>
