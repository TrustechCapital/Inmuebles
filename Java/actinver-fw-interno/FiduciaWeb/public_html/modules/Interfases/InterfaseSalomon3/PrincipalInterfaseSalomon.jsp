<form name="frmDatosInterfase" id="frmDatosInterfase">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
    <tr>
      <td align="center" height="100%" class="titulo">Poliza Contable</td>
    </tr>
    <tr>
      <td height="100%">&nbsp;</td>
    </tr>
    <tr>
      <td height="100%">
        <table width="100%" align="center" class="texto">
          ...
          <tr  valign="middle">
            <td width="20%" align="right"><input type="radio" name="chkPeriodicidad" id="chkAV" class="radio" value="1" />&nbsp;<label for="chkAV">Casa de Bolsa</label></td>
            <td width="20%" align="middle"><input type="radio" name="chkPeriodicidad" id="chkAB" class="radio" value="2" />&nbsp;<label for="chkAB">Banco</label></td></td>
            <td width="20%" align="left"><input type="radio" name="chkPeriodicidad" id="chkAE" class="radio" value="3"/>&nbsp;<label for="chkAE">Honorarios</label></td>
          </tr>
          <tr valign="middle">
    ...
    <tr>
      <td align="center">&nbsp;
        ...
        <input type="button" value="Limpiar" name="cmdLimpiar" id="cmdLimpiar" class="boton" onclick="onButtonClickPestania('Interfases.InterfaseSalomon3.PrincipalInterfaseSalomon','');"/>
      </td>
    </tr>
  </table>
