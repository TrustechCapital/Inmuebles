	...
	<table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="vertical-align:top;">
		...
		<tr>
			<td height="100%">
				<table width="90%" align="center" class="texto" border="0">
					<tr>
						<td width="30%">
							<input type="hidden" id="txtuserId" name="txtusername" value="<%=session.getAttribute("userid")%>" />
						</td>
					...
					<tr>
						...
						<td colspan="2">
							<input type="text" name="paramFiso" id="paramFiso"  size="10"  onchange="verNomFiso();"/>
						</td>
						<td width="30%">
					...
					<tr>
						...
						<td colspan="2">
							<input  id="paramnumfolio" name="paramnumfolio" size="10" fun="loadTableElement" tabla="tblRegCharSol"/>
						</td>
						<td width="30%">
							<input id="paramNomUsuario" name="paramNomUsuario" type="hidden" value="<%=session.getAttribute("username").toString()%>"/>
						</td>
					</tr>    
					<tr>
						<td width="30%">&nbsp;</td>
						<td width="10%">&nbsp;</td>
						<td colspan="2">
							<input  id="paramnumEtapa" name="paramnumEtapa" size="10" style="visibility:hidden" />
						</td>
						<td width="30%">
		...
		<tr>
			<td align="center" valign="middle">
				<font color="#2C3587" size="-1">
					<strong>Solicitudes con Estatus ACTIVO</strong>
				</font>
			</td>
		</tr>
		<tr>
