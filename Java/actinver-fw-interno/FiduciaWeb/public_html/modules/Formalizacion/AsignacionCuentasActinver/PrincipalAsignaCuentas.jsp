<FORM name="frmDatos" id="frmDatos" onsubmit="">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
    <tr>
      <td align="center" height="100%" class="titulo">Asignaci&oacute;n de Cuentas de Actinver</td>
    </tr>
    <tr>
      <td height="100%">&nbsp;</td>
    </tr>
      ...
      <td height="100%">
        <table width="90%" align="center" class="texto">
          ...
          <tr>
            ...
            <input type="BUTTON" value="Regresar" id="cmdRegresar" name="cmdRegresar" class="boton" ref="qryCuentasProspecto2" fun="loadTableElement" tabla="tblReg" onclick="cargaMantenimientoProspectos(operacion);"/></td> <!--ref="conPriDirFid"-->            
          </tr>
          <tr>
            ...
            <td colspan="8" align="center">
              <table cellspacing="0" cellpadding="0" border="0" class="texto">
                <tr class="cabeceras">
                  ...
                  <td width="200" nowrap>&nbsp; No. Cuentas Casa de Bolsa</td>
                </tr>
              </table>
