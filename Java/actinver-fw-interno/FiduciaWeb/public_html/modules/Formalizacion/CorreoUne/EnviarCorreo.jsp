    ...
    String emailTo = "actinver@inscitech";
     ...
     try {
         ...
         //ya que se obtuvieron los valores se procede a armar los correos
            ...
            subject = "Envio Documentacion del Proyecto  "+ String.valueOf(proyecto.intValue()) +" "+ snomNegocio;           
                Properties props = new Properties();
                String fromAddress = ""; //Tecnico Legal
                String toAddress = ""; //Dictaminacion
			...
			System.out.println("Envio de correo 1");
                    ...
                    sCuerpo = sCuerpo +"	<br>";	
                    sCuerpo = sCuerpo +"	Atentamente me permito informar a usted, que el Proyecto numero <b>"+String.valueOf(proyecto)+" "+snomNegocio+"</b>";
                    sCuerpo = sCuerpo +"	<br>";	                    
                    sCuerpo = sCuerpo +"	del Fideicomiso Numero <b>"+String.valueOf(numContrato)+"</b>, es un FIDEICOMISO UNE y por ello requiere su autorizacion"; 
                    sCuerpo = sCuerpo +"	<br>";	
                    sCuerpo = sCuerpo +"	Quedo a sus órdenes para cualquier duda que pudiera surgir.";
                    sCuerpo = sCuerpo +"	<br>";	
                    sCuerpo = sCuerpo +"	Atentamente	";
                    sCuerpo = sCuerpo +"		<br>";
                    sCuerpo = sCuerpo +"	Técnico Legal";                    
