        ...
        <table width="90%" align="center" class="texto" border="0">
          <tr>
            ...
            <tr>
              ...
              <td colspan="2">
                <select size="1" name="prcBanco" id="prcBanco" ref="claves" fun="loadComboElement" keyValue="cveNumSecClave" theValue="cveDescClave" param="clavesCombo27" next="prcTipoCuentas" required message="El Banco es un campo obligatorio"/>
              </td>
              <td align="left" width="10%">&nbsp;</td>
            </tr>
             <tr>
            <td width="12%">&nbsp;</td>
            <td nowrap width="15%">N&uacute;mero de cuentas</td>
            <td>
          ...
          <tr>
              <td width="12%">&nbsp;</td>
              <td nowrap width="15%">Tipo de Cuenta</td>
              <td colspan="2">
                <select size="1" name="prcTipoCuentas" id="prcTipoCuentas" ref="claves" fun="loadComboElement" keyValue="cveNumSecClave" theValue="cveDescClave" param="clavesCombo1006" next="formsLoaded" required message="El Tipo de Cuenta es un campo obligatorio"/>
              </td>
              <td align="left" width="10%">&nbsp;</td>
            </tr>
          </div>
