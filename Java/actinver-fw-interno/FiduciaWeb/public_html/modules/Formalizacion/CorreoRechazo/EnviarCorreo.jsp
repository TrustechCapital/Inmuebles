...
<%
    ...
    BigDecimal numCont = new BigDecimal(0);
    String snomNegocio = "";
    ...
    String emailTo = "actinver@inscitech";
     ...
     try {
         ...
         numCont = (BigDecimal)registro.get("numcontrato");
         
         //ya que se obtuvieron los valores se procede a armar los correos

            subject = "Rechazo del Proyecto "+ String.valueOf(proyecto.intValue()) +" "+ snomNegocio;           
                Properties props = new Properties();
                String fromAddress = ""; 
                String toAddress = ""; //Tecnico Legal
			...
			System.out.println("Envio de correo 1");
                    ...
                    sCuerpo = sCuerpo +"	<br>";	                    
                    sCuerpo = sCuerpo +"	del Fideicomiso <b>"+String.valueOf(numCont)+"</b>"; 
                    sCuerpo = sCuerpo +"	<br>";	
                    sCuerpo = sCuerpo +"	ha sido rechazado";
                    sCuerpo = sCuerpo +"	<br>";	                    
