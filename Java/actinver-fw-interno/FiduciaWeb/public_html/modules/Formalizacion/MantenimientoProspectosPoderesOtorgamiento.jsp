<FORM name="frmDatosMantenimientoProspectosPoderesOtorgamiento" id="frmDatosMantenimientoProspectosPoderesOtorgamiento" onsubmit="">
  <table width="100%" align="center" style="height:auto;">
      <tr align="center">
        <td height="100%">&nbsp;</td>
      </tr>
      <tr>
        <td align="center" height="100%" class="titulo">Otorgamiento</td>
      </tr>
      <tr>
          ...
          <table width="100%" class="texto">
            <tr>
              ...
              <td nowrap style="visibility:hidden">
                <input type="radio" name="rdReferencia" id="podNumPoder3" class="radio" value="3" onclick="asignaValueRadio2Master('podNumPoder',this)" style="visibility:hidden"/>&nbsp;Nafin
              </td>
              <td nowrap>
            ...
            <tr>
              ...
              <td nowrap colspan="2">
                <select id="podTipoApoderado" name="podTipoApoderado" ref="claves" fun="loadComboElement" keyValue="cveDescClave" theValue="cveDescClave" next="podNotarioOto" param="clavesCombo96"/>
              </td>
              ...
              <td colspan="8">
                <table cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    ...
                    <td class="tab_relleno_azul" onclick="cambiaTab(this, 'cargaMantenimientoPoderesOtorgamientoTab()');" nowrap>Otorgamiento</td>
            ...
            <tr>
              ...
              <td class="subtitulo" colspan="8" nowrap>Otorgamiento</td>
              <td class="subtitulo" nowrap width="10%">&nbsp;</td>
            </tr>
            <tr>
              <td width="15%">&nbsp;</td>
              <td nowrap colspan="8">&nbsp;</td>
            ...
            <tr>
              ...
              <td nowrap colspan="2">
                <input type="text" name="podEscrituraOto" id="podEscrituraOto" size="30" maxlength="30"/>
              </td>
              <td colspan="2" nowrap>
                <input type="checkbox" name="podInsRegpubOtoChk" id="podInsRegpubOtoChk" class="check" tv="1" fv="0"/>&nbsp;Inscripci&oacute;n Reg Publico
              </td>
            ...
            <tr>
              <td width="15%">&nbsp;</td>
              <td nowrap>Fecha Escritura</td>
              <td nowrap colspan="2">
                <input type="text" name="podFecEscrOto" id="podFecEscrOto" tipo="Fecha" size="10" maxlength="10"/>
              </td>
              <td nowrap colspan="2">Fecha Reg</td>
              <td nowrap colspan="3">
                <input type="text" name="podFecRegOto" id="podFecRegOto" tipo="Fecha" size="10" maxlength="10"/>
              </td>
              <td nowrap width="10%">&nbsp;</td>
            </tr>
            <tr>
              ...
              <td nowrap colspan="2">Folio Mercantil</td>
              <td nowrap colspan="3">
                <input type="text" name="podFolMercanOto" id="podFolMercanOto" size="25" maxlength="25"/>
              </td>
              <td nowrap width="10%">&nbsp;</td>
            </tr>
            <tr align="center">
            ...
            <tr>
              <td width="15%">&nbsp;</td>
              <td nowrap>Facultades de Sust.</td>
              <td nowrap colspan="7">
