            ...
            <tr align="center">
              <td colspan="6">
                ...
                <div style="height:250px; overflow:auto; position:relative; vertical-align:top; width:633px;">
                  <table id="tablaRegistrosFinalidadesContrato" border="0" cellspacing="0" cellpadding="0" width=633px dataInfo="tablaFinalidadesContratoData" keys="finNumContrato,finCveTipoFinal,finFolioFinalidaAnteproy" fun="clickTabla" radioWidth="23" NoRecordsMsg="No existen Registros para estos criterios de b&uacute;squeda">
                  </table>
                </div>
              </td>
            </tr>
