        ...
        <td height="100%">
          <table width="90%" align="center" class="texto">
            ...
            <tr valign="middle">
              ...
              <td width="216">
                <input type="text" name="txtNomProyecto" id="txtNomProyecto" tipo="AlphaNumeric" size="100"/>
              </td>
              <td width="217">&nbsp;<!--input type="text" name="txtNomProyecto" id="txtNomProyecto" tipo="AlphaNumeric" size="40"/-->
              </td>
              <td width="10%">&nbsp;</td>
            ...
            <tr>
              ...
              <table cellpadding="0" cellspacing="0">
                <tr>                  
                   ...
                   <td width="112"  align="center" valign="middle"> <input type="BUTTON" value="Propietario R." id="cmdConsultarKYCP" name="cmdConsultarKYCP" onmouseover="this.className='boton_rightSobre'" onmouseout="this.className='boton_right';" class="boton_right" onclick="cargaMantenimientoFideicomitentes(4)"/> </td>
