  ...
  function datosObtenidos(opc,result){
      ...
      if(res==0)
         ...
         alert("ocurri\u00F3 un error al obtener los datos de la ficha única")
      }
  }
...
function recogerDatosParaPantallaMantenimiento(opc){
  ...
  function cargaTipoPantalla(){
       if(opcion==vgFunPtoRev){
          var urlCliente = ctxRoot + "/modules/Formalizacion/CharolaSolicitudAdmon3/PuntosRevisionSolicitudesAdmon.do";
          makeAjaxRequest(urlCliente, "HTML", despliegaPantalla, null);
       }
       else{
          var urlCliente = ctxRoot + "/modules/Formalizacion/CharolaSolicitudAdmon3/DocumentosSolicitudesAdmon.do";
          makeAjaxRequest(urlCliente, "HTML", despliegaPantalla, null);
       }
    }
  ...
  function regresarAlaCharola(){
    ...
    onButtonClick("Formalizacion/CharolaSolicitudAdmon3/CharolaSolicitudAdmon","");
    hideWaitLayer();
  }
  ...
  function ejecutaFuncion(tp,result){
     ...
     if(res.result==0){
      ...
      alert("No se puede rechazar una solicitud con todos los puntos de revisi\u00F3n correctos");      
       ...
       alert("Ocurri\u00F3 un error al tratar de modificar el valor")
     }
  }
   ...
   switch(r){
     ...
     case  0: 
      if(vgopcAutRech!=1){
       ...
       {  */    
          alert("Operacion Realizada Satisfactoriamente, se envio correo a Promoci\u00F3n");  
       ...
       {*/
        ...
        vgContenedorDatos.numOper=pkInfoCharSol.insNumOper;
        vgContenedorDatos.usuario=eval(GI("txtuserId").value)
        //vgContenedorDatos.numEtapa='PLD';
  ...
  function ejecutaAutorizaRechazaFrmElec(obj, resultado){ 
   ...
   switch(r){
     ...
     case  0: 
      //enviarFirma(); 
        alert("Operacion Realizada Satisfactoriamente, se envio correo a Promocion");  
...
function regresarAlaCharola2(){
    ...
    var urlCliente = "modules/Formalizacion/CharolaSolicitudAdmon3/CharolaSolicitudAdmon.do";
...
function getViewer(obj){
   ...
   function viewDoc(objBtn) {
	...
	switch(parseInt(objSel.value)) {
		...
		case 101: case 301: //Identificacion Oficial vigente
			...
			break;
		case 102: case 204://En su caso Acuerdo del Comite
  ...
  function ejecutaAutorizaRechazaProyecto(obj, resultado){ 
   ...
   switch(r){
     case -1: alert("A ocurrido un error"); break;
     case  0: 
        alert("Proyecto Autorizado Satisfactoriamente, se envi\u00F3 correo a Administraci\u00F3n");  
        enviaCorreo(pkInfoCharSol.insNumFolioInst);	         
        consultar(GI("cmdAceptar"), GI("frmCharolaSolicitudes"), false);       
        break;
     case  1: 
