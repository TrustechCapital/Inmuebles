          ...
          <table width="90%" align="center" class="texto" border="0">
            ...
            <tr>
              <td colspan="5" align="center" valign="middle">
                <input type="button" value="Buscar" name="cmdAceptar" id="cmdAceptar" class="boton" ref="qryCharolInstrucAdmonPLD" fun="loadTableElement" tabla="tblRegCharSol" param="paramQueryAdmon" onclick="consultar(this, frmCharolaSolicitudes, false);"/>
...
<td align="center">
                ...
                <div style="height:250px; overflow:auto; position:relative; vertical-align:top;width:1193px">
                <table border="0" cellpadding="0" cellspacing="0" class="texto" id="tblRegCharSol" dataInfo="arrTblDatCharSol" keys="insNumContrato,insNumFolioInst,insCveStInstruc,insNumOper,insTxtComentario,promotor,producto,tipo,nombre,clasifica,pais" fun="clickTablaCharSol" radioWidth="23px" NoRecordsMsg="No existen Registros para estos criterios de b&uacute;squeda">
                </table>
              </td>
             </tr>
...
<tr><td align="center" valign="middle">&nbsp;</td></tr>
<tr><td align="center" valign="middle">
                <input type="BUTTON" name="cmdAutoriza" value="Autorizar Persona" class="boton" onclick="autorizaRechaza(1);"> 
                <input type="BUTTON" name="cmdRechaza" value="Rechazar Persona" class="boton" onclick="autorizaRechaza(2);">
</td></tr>
<tr align="center">
	<td colspan="5">
...
<tr style="visibility:visible">
	<td colspan="2" align="center" valign="middle">
		<input type="button" value="Expendiente Incompleto" class="boton"  onclick="AgregaArchivo();"/>
	</td>
</tr>
