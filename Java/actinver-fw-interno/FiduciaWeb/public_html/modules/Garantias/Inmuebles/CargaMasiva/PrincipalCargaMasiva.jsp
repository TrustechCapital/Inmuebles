        ...
        <table align="center" class="texto" width="100%">
         <tr>
          ...
          <tr>
            ...
            <td nowrap>
              <input type="radio" name="rdTipoMovimiento" id="rdTipoLiberacion" value="4" class="radio" onclick="asignaValueRadio2Master('rdTipoMovimiento',this)"/>Liberaci&oacute;n</td>
            <td nowrap>
              <input type="radio" name="rdTipoMovimiento" id="rdDerechoCobro" value="5" class="radio" onclick="asignaValueRadio2Master('rdTipoMovimiento',this)"/>Derechos Cobro</td>
