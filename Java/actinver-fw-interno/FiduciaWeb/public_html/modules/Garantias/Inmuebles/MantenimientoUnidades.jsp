<form name="frmMantenimientoUnidades" id="frmMantenimientoUnidades" onsubmit="">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
    <tr>
      <td align="center" height="100%" class="titulo">Mantenimiento Unidades</td>
    </tr>
    <tr>
      <td height="100%">&nbsp;</td>
    </tr>
    <tr>
      <td height="100%">
        <table width="100%" class="texto">
           ...
           <tr>
            <td width="10%">&nbsp;</td>
            <td width="20%">N&uacute;m. Inmueble</td>
            <td>
              <input type="text" name="funiIdBien" id="funiIdBien" size="10" maxlength="10" required message = "Valor obligatorio"/>
            </td>
            <td>Sub Cuenta</td>
            <td>
              <input type="text" name="funiIdSubcuenta" id="funiIdSubcuenta" tipo="Num" size="10" maxlength="10" value="0" required message="Valor obligatorio"/>
            </td>
            <td>&nbsp;
            </td>
            <td width="10%">&nbsp;</td>
          ...
          <tr>
            ...
            <td>
              <input type="text" name="funiIdEdificio" id="funiIdEdificio" size="10" maxlength="50" required message="Valor obligatorio"/>
            </td>
            <td>
              Unidad Condominal:
            </td>
           ...
           <tr>
            <td width="10%">&nbsp;</td>
            <td width="15%">Niveles:<!--Num. Unidad--></td>
            <td>
          ...
          <tr>
           ...
           <!--tr>
            ...
            <td>
              <textarea name="funiColindancias" id="funiColindancias" style="width:250px;height:90px" required message = "Valor obligatorio"></textarea>
            </td>
            <td>Medidas:</td>
            <td>
              <textarea name="funiMedidas" id="funiMedidas" style="width:150px;height:40px" required message = "Valor obligatorio"></textarea>
            </td>
            <td>&nbsp;</td>
            <td width="10%">&nbsp;</td>
          </tr-->
          ...
          <tr>
            ...
            <td><input type="text" name="funiSotano" id="funiSotano" size="10" maxlength="50"/></td>
            <td>Superficie Otro 2:</td>
            <td><input type="text" name="funiSotanoSuperficie" id="funiSotanoSuperficie" size="10" maxlength="50"/></td>
            <td>&nbsp;</td>
            <td width="10%">&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <td>Fecha Reversi�n</td>
            <td>
              <input type="text" name="funiFechaReversion" id="funiFechaReversion" tipo="Date" size="10" maxlength="10"/>
            </td>
            <td>&nbsp;
            </td>
            <td width="10%">&nbsp;</td>
