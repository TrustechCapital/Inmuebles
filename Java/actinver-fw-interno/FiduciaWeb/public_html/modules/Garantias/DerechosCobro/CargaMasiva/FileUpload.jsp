  ...
  <body style="background-color:transparent;">
   <center> 
    <form name="frmCargaComprasVentas" enctype="multipart/form-data" method="post" action="<%=request.getContextPath()%>/upload.do">
      ...
      <input type="hidden" id="processor" name="processor" value="mx.gob.nafin.fiduciario.business.upload.processors.CargaArchivosExcelPagaresImpl" />
      <input type="hidden" id="processID" name="processID" value="" />
      
      <table border="0" cellpadding="1" cellspacing="3" align="center">
        <tr>  
          <td class="texto">Archivo a Cargar:</td>
          <td><input type="FILE" name="fileTest" id="fileTest" /></td><!--onchange="parent.borraArchivoTAS(this.value);"-->
        </tr>
      </table>      
