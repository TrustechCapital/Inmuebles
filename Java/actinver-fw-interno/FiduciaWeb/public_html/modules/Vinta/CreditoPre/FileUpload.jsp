    ...
    <form id="frmTest" name="frmTest" enctype="multipart/form-data" method="POST" action="<%=request.getContextPath()%>/upload.do">
      <table border="0" cellpadding="1" cellspacing="3" align="center">
        <tr>
          ...
          <td><input class="boton" type="button" value="Subir Archivo" onclick="parent.frameSubmit(frmTest);"/></td>
          <td><input class="boton" type="button" value="Cargar Garant&iacute;as" onclick="parent.frameSubmit(frmTest);"/></td>
        </tr>
        <tr>
          <td colspan="3">
            ...
            <input type="text" id="processor" name="processor" value="mx.gob.nafin.fiduciario.business.upload.processors.CargaFosegProcessorImpl" style="visibility:hidden" size="5"/>
          </td>
        </tr>
      </table>
    </form>
