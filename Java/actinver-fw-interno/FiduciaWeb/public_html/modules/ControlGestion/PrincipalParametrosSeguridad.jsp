      ...
      <td height="100%">
        <table cellspacing="2" cellpadding="3" border="0" width="100%" class="texto">
          <tr>
            ...
            <td>
              <input type="text" name="ctoNumContrato" id="ctoNumContrato" tipo="Num" size="15" onblur="muestraDatosConsulta();" required message="El n�mero de fideicomiso es obligatorio"/>
            </td>
