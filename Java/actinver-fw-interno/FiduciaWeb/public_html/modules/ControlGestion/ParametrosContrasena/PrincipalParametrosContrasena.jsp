        ...
        <table width="100%" align="center" class="texto">
          <tr>
            ...
            <td nowrap width="15%">Instituci&oacute;n</td>
              <td nowrap colspan="2">
                <select size="1" name="paramempresa" id="paramempresa" ref="cmbParamEmpresa1" fun="loadComboElement" keyValue="empNumEmpresa" theValue="empNomEmpresa"  param="cmbEmpresas" next="formsLoaded"/>
            <td width="40%">
              &nbsp;
            </td>
            <td width="15%">&nbsp;</td>
          ...
          <tr>
            ...
            <table width="224" cellpadding="0" cellspacing="0">
                ...
                <td width="112"  align="center" valign="middle">
                  <input type="BUTTON" value="Aceptar" id="cmdAceptar" name="Aceptar" class="boton_left" onmouseover="this.className='boton_leftSobre'" onmouseout="this.className='boton_left';" ref="qryParamPwd" fun="loadTableElement" tabla="tabla" onclick="if(fvMantenimiento.checkForm())consultar(this, GI('frmDatos'), false);">
                  </td>
                  <td width="112" align="center" valign="middle">
          ...
          <tr align="center">
            <td colspan="5">
              ...
              <div style="height:250px; overflow:auto; position:relative; vertical-align:top;">
                <table id="tabla" border="0" cellspacing="0" cellpadding="0" dataInfo="tablaData" keys="fpaNumInstitucion" fun="clickTabla" radioWidth="23" NoRecordsMsg="No existen Registros para estos criterios de b&uacute;squeda">
                </table>
              </div>
            </td>
          </tr>
