...
function asginaNiveles(){
    var x=GI("tmpnivel").value;
    var y=x.split("/");
    //alert(y[0]);
    GI("perNumNivel1").value=y[0];
    GI("perNumNivel2").value=y[1];
    GI("perNumNivel3").value=y[2];
    GI("perNumNivel4").value=y[3];
    GI("perNumNivel5").value=y[4];
}
