<FORM name="frmCharolaSolicitudes" id="frmCharolaSolicitudes" onsubmit="">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="vertical-align:top;">
      <tr>
        <td align="center" height="100%" class="titulo">Charola de Instrucci&oacute;n Monetaria</td>
      </tr>
      <tr>
        <td height="100%">&nbsp;</td>
      </tr>
          ...
          <table width="90%" align="center" class="texto" border="0">
            ...
            <tr>
              <td colspan="5" align="center" valign="middle">
                <input type="button" value="Buscar" name="cmdAceptar" id="cmdAceptar" class="boton" ref="qryCharolInstrucAdmon4" fun="loadTableElement" tabla="tblRegCharSol" param="paramQueryAdmon" onclick="consultar(this, frmCharolaSolicitudes, false);"/>
                <input type="button" name="cmdLimpiar" id="cmdLimpiar" value="Limpiar" class="boton" onclick="limpiarConsultas();"/><!--regresarAlaCharola();-->
              </td>
            </tr>
            <tr><td colspan="5" align="center" valign="middle">&nbsp;
            </td></tr>
...
<tr><td align="center" valign="middle"><font color="#2C3587" size="-1"><strong>Solicitudes con Estatus APROBADA</strong></font></td></tr>
<tr>
<td align="center">
                <table cellspacing="1" cellpadding="0" border="0">
                  <tr align="left" class="cabeceras">
                    ...
                    <td width="100px">Fch Instrucci&oacute;n</td>                    
