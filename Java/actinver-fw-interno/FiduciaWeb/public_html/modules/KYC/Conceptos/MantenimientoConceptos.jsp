  ...
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
        ...
        <table width="100%" class="texto">
         ...
         <!-- <tr>  
          ...
          <tr id="trconpTabla">
            ...
            <td colspan="4">              
              <select size="1" name="conpTabla" id="conpTabla" ref="conETDatInd" fun="loadComboElement" keyValue="eindDescripcion" theValue="eindDescripcion" param="cmbCriterio" next="conpEstatus" onchange="GI('conpBaseCheck').checked=((this.selectedIndex!=0)?true:false);obtenClave(this);"/>
          ...
          <tr>
            <td>&nbsp;<input type="hidden" name="conpClave" id="conpClave" maxlength="100" size="20" style="position:absolute;"/></td>
            <td>Estatus</td>
            <td colspan="4">
    ...
    <tr>
      <td align="center">
        ...
        <input type="button" value="Cancelar" name="cmdCancelar" id="cmdCancelar" class="boton_x" onclick="onButtonClickPestania('KYC.Conceptos.PrincipalConceptos','')" style="visibility:hidden;position:absolute"/>
      </td>
    </tr>
  </table>
</form>
