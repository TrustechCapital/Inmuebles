<FORM name="frmDatosMantenimientoNotarios" id="frmDatosMantenimientoNotarios" onsubmit="">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
      ...
      <tr>
        <td height="100%" align="center">
          ...
          <input type="button" value="Cancelar" name="cmdCancelar" class="boton_x" onclick="cargaPrincipalProspectosNotarios();" style="visibility:hidden"/>
        </td>
      </tr>
    <tr>
      <td height="100%">&nbsp;</td>
