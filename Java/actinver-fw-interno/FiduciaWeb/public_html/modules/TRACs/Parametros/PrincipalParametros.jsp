            ...
            <td colspan="5">
              <table cellspacing="0" cellpadding="0" border="0">
                <tr align="left" class="cabeceras">
                  ...
                  <td width="100px">Hr Finalizaci�n</td>
                  <td width="100px">Ampliar Hr</td>
                  <td width="100px">M�ximo Creaciones D�a</td>
                  <td width="100px">M�ximo Creaciones CB</td>
              ...
              <div style="height:250px; overflow:auto; position:relative; vertical-align:top;">
                <table id="tabla" border="0" cellspacing="0" cellpadding="0" dataInfo="tablaData" keys="patIdPizarra,patIdSerie,patIdCupon" fun="clickTabla" radioWidth="23" NoRecordsMsg="No existen Registros para estos criterios de b&uacute;squeda">
                </table>
              </div>
            </td>
          </tr>
