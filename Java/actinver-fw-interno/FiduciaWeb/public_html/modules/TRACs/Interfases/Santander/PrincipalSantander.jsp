<form name="frmDatosInterfase" id="frmDatosInterfase" onsubmit=" ">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
    <tr>
      <td align="center" height="100%" class="titulo">Interfase Custodio</td>
    </tr>
    <tr>
      <td height="100%">&nbsp;&nbsp;</td>
    </tr>
        ...
        <table width="90%" align="center" class="texto">
          ...
          <tr valign="middle">
            ...
            <td align="center" colspan=2>
                <input type="radio" name="chSantander" id="chSantander" class="radio" value="ENVIO" checked/>Envío Custodio &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <input type="radio" name="chSantander" id="chSantander2" class="radio" value="RECEPCION"/>Recepción Custodio
            </td>
            <td align="left" width="24%">&nbsp;</td>
          </tr>
    ...
    <tr>
              <td colspan="2">
                <iframe id="frameUpload" name="frameUpload" align="center" style="z-index:1;visibility:visible;" src="<%=request.getContextPath()%>/modules/TRACs/Interfases/Santander/SantanderUpload.do" frameborder="0" scrolling="no" width="600" height="50" AllowTransparency></iframe>
    ...
    <tr>
      <td align="center">&nbsp;
        ...
        <input type="button" value="Aplicar" name="cmdAplicar" id="cmdAplicar" class="boton" onclick="ejecutaStoreInterfase(frmDatosInterfase);"/>&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="button" value="Limpiar" name="cmdLimpiar" id="cmdLimpiar" class="boton" onclick="onButtonClickPestania('TRACs.Interfases.Santander.PrincipalSantander','');"/>
