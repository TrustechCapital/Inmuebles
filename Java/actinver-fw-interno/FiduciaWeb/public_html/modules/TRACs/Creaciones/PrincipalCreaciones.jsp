<FORM name="frmDatos" id="frmDatos" onsubmit="">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
      ...
      <tr>
        <td align="center" height="100%" class="titulo">Creación</td>
      </tr>
      <tr>
        <td height="100%">&nbsp;</td>
      </tr>
      <tr>
        <td height="100%">
          <table class="texto">
            ...
            <tr>
              <td width="15%">&nbsp;</td>
              <td nowrap>Fecha Creación</td>
              <td nowrap colspan=3>
                <input type="text" id="fecCreacion" name="fecCreacion" maxlength="10" size="10" tipo="Fecha" required message="La Fecha de Creación es un campo obligatorio"/>
              </td>
      ...
      <tr>
        <td height="100%" align="center">
          ...
          <input type="button" value="Cancelar" name="cmdCancelar" class="boton_x" onclick="RF(frmDatos);fechaTrack(GI('fecCreacion'));" ><!--style="visibility:hidden"/>-->
        </td>
      </tr>
    <tr>
      <td height="100%">&nbsp;</td>
