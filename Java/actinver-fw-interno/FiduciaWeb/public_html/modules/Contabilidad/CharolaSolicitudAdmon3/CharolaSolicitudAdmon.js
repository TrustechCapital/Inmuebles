  ...
  var asignaPerfil = JSON.parse("{\"numEtapa\":\""+eval(6)+"\"}");
  ...
  //***FUNCIONALIDAD BOTONES*********************************************************************************************************************
    function funcionDelBoton(opc){
       if(isDefinedAndNotNull(pkInfoCharSol)){
          ...
          paramsQryDocumentsCbo = JSON.parse("{\"numOper\":\"" +pkInfoCharSol.insNumOper + "\",\"numEtapa\":\""+eval(6)+"\"}");
          showWaitLayer();
...
function recogerDatosParaPantallaMantenimiento(opc){
  ...
  function cargaTipoPantalla(){
       if(opcion==vgFunPtoRev){
          var urlCliente = ctxRoot + "/modules/Contabilidad/CharolaSolicitudAdmon3/PuntosRevisionSolicitudesAdmon.do";
          makeAjaxRequest(urlCliente, "HTML", despliegaPantalla, null);
       }
       else{
          var urlCliente = ctxRoot + "/modules/Contabilidad/CharolaSolicitudAdmon3/DocumentosSolicitudesAdmon.do";
          makeAjaxRequest(urlCliente, "HTML", despliegaPantalla, null);
       }
    }
  ...
  function regresarAlaCharola(){
    onButtonClick("/Contabilidad/CharolaSolicitudAdmon3/CharolaSolicitudAdmon","");
    hideWaitLayer();
  }
  ...
  function despliegaTabla(tabla,obj){
    vgObjqryllenaTablaAdmon=JSON.parse("{\"id\":\"qryllenaTablaAdmon\"}");
          ...
          vgObjqryllenaTablaAdmon.numEtapa=eval(6);
  ...
  function autorizaRechaza(opc){
	 ...
	 if(isDefinedAndNotNull(pkInfoCharSol)){ 
        ...
        vgContenedorDatos.numEtapa=eval(6);
  ...
  function ejecutaAutorizaRechaza(obj, resultado){ 
   ...
   switch(r){
	 ...
	 case  5: alert("Imposible Contabilizar sin Operacion Contable, valide Num Operacion"); break;
   }
  }
  ...
  function generaReporte(){
     ...
     parametrosUrl.urlReporte="/jsp/Reportes/Contabilidad/Finalidades.jsp"
     parametrosUrl.id="repFinalidadesContabilidad";
  ...
  function  AgregaArchivo(){
     ...
     var parametrosUrl = new Object;
     parametrosUrl.sendToJSP="true";
     parametrosUrl.urlReporte="/jsp/Reportes/Contabilidad/AgregaArchivo.jsp"
     parametrosUrl.id="repFinalidadesContabilidad";
...
function regresarAlaCharola2(){
    ...
    var urlCliente = "modules/Contabilidad/CharolaSolicitudAdmon3/CharolaSolicitudAdmon.do";
  ...
  function enviarFirma(){
     ...
     /*if(pkcs7_=="")
      pkcs7_="vacio"*/
     //parametrosUrl.urlReporte="/jsp/Reportes/Contabilidad/EnviarFirma.jsp";
     parametrosUrl.urlReporte="/modules/Contabilidad/CharolaInstruccionAdmon/EnviarFirma.jsp";
