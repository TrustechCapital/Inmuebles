          ...
          <table width="90%" align="center" class="texto" border="0">
            ...
            <tr>
              <td colspan="5" align="center" valign="middle">
                <input type="button" value="Buscar" name="cmdAceptar" id="cmdAceptar" class="boton" ref="qryCharolInstrucAdmon5" fun="loadTableElement" tabla="tblRegCharSol" param="paramQueryAdmon" onclick="consultar(this, frmCharolaSolicitudes, false);"/>
