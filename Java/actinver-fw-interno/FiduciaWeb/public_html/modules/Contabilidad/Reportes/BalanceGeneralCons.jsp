...
<input type="hidden" id="urlReporte" name="urlReporte" value="<%=request.getContextPath()%>/jsp/fiduciav5/balanceGeneralCons.jsp?"/>
...
<table border="0" cellpadding="1" class="texto" cellspacing="5" width="100%">
  ...
  <tr>
    <td>Firma:</td>
    <td>
      <select size="1" name="paramEjecutivoFirma" id="paramEjecutivoFirma" ref="cmbParamEmpresaAll" fun="loadComboElement" keyValue="empNomFirma" theValue="empNomFirma" next="formsLoaded"/>
    </td>
  </tr>  
</table>
