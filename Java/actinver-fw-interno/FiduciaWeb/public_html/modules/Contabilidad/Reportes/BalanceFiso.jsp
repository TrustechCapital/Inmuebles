...
<input type="hidden" id="refSP" name="refSP" value="ejeStoBalFid"/>
<input type="hidden" id="refQry" name="refQry" value="getBalFid"/>
<input type="hidden" id="paramsendToJSP" name="paramsendToJSP" value="true"/>
<input type="hidden" id="paramurlReporte" name="paramurlReporte" value="/jsp/Reportes/Contabilidad/BalanceFiso.jsp"/>
