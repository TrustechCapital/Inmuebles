...
<input type="hidden" id="refSP" name="refSP" value="ejeStoBalCueOrd"/>
<input type="hidden" id="refQry" name="refQry" value="getBalCueOrd"/>
<input type="hidden" id="paramsendToJSP" name="paramsendToJSP" value="true"/>
<input type="hidden" id="paramurlReporte" name="paramurlReporte" value="/jsp/Reportes/Contabilidad/BalanzaCuentasOrden.jsp"/>
...
<table border="0" cellpadding="1" class="texto" cellspacing="5" width="100%">
  <tr>
    <td>Fideicomiso:</td>
    <td>
      <input type="text" id="paramFiso" name="paramFiso" required tipo="Numero" message="El Fideicomiso es un campo obligatorio" maxlength="10" size="10">
    </td>
  </tr>  
  <tr>
    <td>Fecha:</td>
