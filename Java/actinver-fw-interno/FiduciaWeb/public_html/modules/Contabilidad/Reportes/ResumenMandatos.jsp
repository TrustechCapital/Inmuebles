...
<input type="hidden" id="refQry" name="refQry" value="getResumenMandatos"/>
<input type="hidden" id="paramsendToJSP" name="paramsendToJSP" value="true"/>
<input type="hidden" id="paramurlReporte" name="paramurlReporte" value="/jsp/Reportes/Contabilidad/ResumenMandatos.jsp"/>
<!--input type="hidden" id="template" name="template" value="/xml/Reportes/Contabilidad/template.xsl"/>
<input type="hidden" id="nombreReporte" name="nombreReporte" value="Resumen de Mandatos"/>
