      ...
      <td height="100%">
        <table width="90%" align="center" class="texto" border="0">
          ...
          <tr>
            ...
            <td colspan="6"><label id="salNomContrato" class="textoNegrita" ref="conNomFid" fun="asignaValor2DivFideicomiso" param="divNombreFideicomisoParam"></label></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td width="20%">&nbsp;</td>
          ...
          <tr>
            <td colspan="11" align="center">
              <input type="button" value="Regresar" name="cmdCancelar" id="cmdCancelar" class="boton" onclick="cargaPrincipalConsultaSaldosFideicomiso();"/>
            </td>
          </tr>
          <tr>
