      ...
      <td height="100%">
        <table width="100%" class="texto">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="txtValor7" id="txtValor7" size="10" maxlength="25" tipo="valMoneyComas" onchange="format(this)"  required style="visibility:hidden"/>
            </td>
            <td align="right">
          ...
          <tr>
            ...
            <td style="visibility:hidden">
              <input type="text" name="txtValor8" id="txtValor8" size="10" maxlength="25" 
tipo="valMoneyComas" onchange="format(this)" required />
            </td>
            <td align="right">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="txtValor9" id="txtValor9" size="10" maxlength="33" required tipo="valMoneyComas" onchange="format(this)" style="visibility:hidden"/>
            </td>
            <td align="right">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="txtValor10" id="txtValor10" size="10" maxlength="33" required tipo="valMoneyComas" onchange="format(this)"  style="visibility:hidden"/>
            </td>
            <td align="right">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="txtValor11" id="txtValor11" size="10" maxlength="25" required tipo="valMoneyComas" onchange="format(this)"  style="visibility:hidden"/>
            </td>
            <td align="right">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="txtValor12" id="txtValor12" size="10" maxlength="25" required tipo="valMoneyComas" onchange="format(this)"  style="visibility:hidden"/>
            </td>
            <td align="right">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="txtValor13" id="txtValor13" size="10" maxlength="25" required tipo="valMoneyComas" onchange="format(this)"  style="visibility:hidden"/>
            </td>
            <td align="right">
