...
fvReportes.setup({
  formName      : "frmInformesGerenciales",
  tipoAlert     : 1,
...
function setFechaCal() {
  ...
  else if(isDefinedAndNotNull(GI("paramFechaInical"))&&isDefinedAndNotNull(GI("paramFechaFinal")))
  {
...
function ejecutaReporte() {
 ...
 if(fvReportes.checkForm()&&bandera==1) {
    var parametros = getParameters(GI("frmInformesGerenciales"));
...
{
  cmbCtaChequesParam.fideicomiso = eval(s_fside);
