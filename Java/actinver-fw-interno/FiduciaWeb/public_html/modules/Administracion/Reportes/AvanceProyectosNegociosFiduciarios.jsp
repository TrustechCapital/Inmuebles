...
<input type="hidden" id="refSP" name="refSP" value="repAvanceProyectosNegociosFiduciarios"/>
<input type="hidden" id="refQry" name="refQry" value="getAvanceProyectosNegociosFiduciarios"/>
