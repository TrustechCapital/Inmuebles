      ...
      <td height="100%">
        <table cellspacing="2" cellpadding="3" border="0" width="100%" class="texto">
          <tr>
            ...
            <td width="20%">
              <input type="text" name="fsctIdFideicomiso" id="fsctIdFideicomiso" tipo="Num" size="10" maxlength="10" onblur="validarPkAlta(this);" required message="El N�mero de Fideicomiso es un campo obligatorio" onblur="verificaExistenciaRegistro();"/>
            </td >
            <td width="35%">
          ...
          <tr>
            ...
            <td>
              <input type="text" name="fsctIdSubCuenta" id="fsctIdSubCuenta" tipo="AlphaNumeric" size="10" maxlength="3" required message="El N�mero de Sub Cuenta es un campo obligatorio"/>
            </td>
            <td width="5%">&nbsp;</td>
          </tr>
          <tr>
