                ...
                <table align="center" class="texto" width="100%">
                    <tr valign="middle">
                        ...
                        <td>
                            ...
                            <input type="text" name="nomFideicomiso" id="nomFideicomiso"  size="60" disabled/>       
                        </td>                        
                    </tr>
                        ...
                        <td colspan="6" align="center">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td width="112" align="center" valign="middle">
                                        <input type="BUTTON" value="Ficha T&eacute;cnica" id="cmdFicha" name="cmdFicha"
            ...
            <td colspan="6">
                <table cellspacing="0" cellpadding="0" border="0">
                    <tr class="cabeceras">
                        ...
                        <td width="300px" nowrap="nowrap">Descripci&oacute;n</td>
