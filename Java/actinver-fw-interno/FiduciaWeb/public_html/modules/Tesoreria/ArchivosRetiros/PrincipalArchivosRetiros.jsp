<form name="frmDatos" id="frmDatos">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
    <tr>
      <td align="center" height="100%" class="titulo">Archivo de Retiros</td>
    </tr>
    <tr>
      <td height="100%">&nbsp;</td>
    </tr>
    <tr>
      <td height="100%">
        <table width="90%" align="center" class="texto">
          <tr>
            <td width="20%">&nbsp;</td>
            <td width="20%" nowrap>Estado del Retiro</td>
            <td>
              <input type="radio" name="rdEstadoDeposito" id="rdEstadoDeposito1" class="radio" value2="1" required message="El Estado del Retiro es un campo obligatorio" onclick="asignaValueRadio2Master('rdEstadoDeposito1',this);"/>Operable
            </td>
            <td>
          ...
          <tr>
            ...
            <td width="20%" nowrap>&nbsp;</td>
            <td colspan="3">
              <input type="radio" name="rdArchivo" id="rdArchivo4" value="4" class="radio" onclick="asignaValueRadio2Master('rdArchivo1',this);"/>Formas de Liquidaci&oacute;n
            </td>
            <td width="10%">&nbsp;</td>
          </tr>
          <tr>
    ...
    <tr>
      <td align="center">&nbsp;
        <input type="button" value="Aceptar" name="cmdAceptar" id="cmdAceptar" class="boton" onclick="ejecutaFuncionArchivosRetiros();"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="button" value="Limpiar" name="cmdLimpiar" id="cmdLimpiar" class="boton" onclick="onButtonClickPestania('Tesoreria.ArchivosRetiros.PrincipalArchivosRetiros','');"/>
      </td>
    </tr>
  </table>
</form>
