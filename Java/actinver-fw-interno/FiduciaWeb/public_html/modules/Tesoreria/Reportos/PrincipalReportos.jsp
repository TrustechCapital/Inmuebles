<form name="frmReportos" id="frmReportos">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
    <tr>
      <td height="100%">&nbsp;</td>
    </tr>
    <tr>
      <td align="center" height="100%" class="titulo">Establecimiento de Reportos</td>
    </tr>
    <tr>
      <td height="100%">&nbsp;</td>
    </tr>
        ...
        <table width="90%" align="center" class="texto" border="0">
          <tr valign="middle">
            ...
            <td nowrap colspan="3">
              ...
              <input type="text" name="txtFechaContable" id="txtFechaContable" size="10" ref="conFecCon" fun="loadTxtElementX" theValue="fecha" tipo="Fecha" next="cmbMercado" style="visibility:hidden"/>
              ...
              <input type="text" name="txtRetencionISR" id="txtRetencionISR" size="1" ref="conRetISR" fun="loadTxtElementX" theValue="retencionIsr" param="txtRetencionParam" next="ejecutaReporto" style="visibility:hidden"/>
            </td>
            <td nowrap>&nbsp;
            </td>
            <td width="15%">&nbsp;</td>
          ...
          <tr valign="middle">
            ...
            <td colspan="3">
              <select name="cmbMercado" id="cmbMercado" ref="cvesReportos" fun="loadComboElement" keyValue="cveNumSecClave" theValue="cveDescClave" next="formsLoaded" required message="El Mercado es un campo obligatorio" onchange="cargaComboInstrumentos(this);"/>
            </td>
            <td>&nbsp;
            </td>
            <td width="15%">&nbsp;</td>
          ...
          <tr valign="middle">
            ...
            <td colspan="4">
              <select size="1" name="cmbInstrumento" id="cmbInstrumento" ref="conIns" fun="loadComboElement" keyValue="insNumInstrume" theValue="insNomInstrume" param="cmbInstrumentoParam" next="formsLoaded" required message="El Instrumento es un campo obligatorio">
    ...
    <tr>
      <td align="center" valign="middle" width="15%">&nbsp;
        ...
        <input type="BUTTON" name="cmdLimpiar" id="cmdLimpiar" value="Limpiar" class="boton" onclick="onButtonClickPestania('Tesoreria.Reportos.PrincipalReportos','');"/>
      </td>
    </tr>
    <tr>
      <td height="100%">&nbsp;</td>
