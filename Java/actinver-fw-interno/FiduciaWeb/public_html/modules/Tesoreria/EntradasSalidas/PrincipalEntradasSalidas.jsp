          ...
          <tr>
            <td colspan="8" width="15%">
              ...
              <div style="height:150px; overflow:auto; position:relative; vertical-align:top;">
                <table id="tblRegPriPos" border="0" cellspacing="0" cellpadding="0" dataInfo="arrTblPosDat" keys="posCveTipoMerca,posNumInstrume,posNumSecEmis,posNomPizarra,posNumSerEmis,posNumCuponVig" fun="clickTabla" radioWidth="23" NoRecordsMsg="No existen Registros para estos criterios de b&uacute;squeda">
                </table>
              </div>
            </td>
          </tr>
