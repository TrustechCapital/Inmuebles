      ...
      <td height="100%">
        <table width="90%" align="center" class="texto" border="0">
          ...
          <tr align="center">
            ...
            <td width="15%">
              <input type="text" name="txtNoTitulos" id="txtNoTitulos" size="10" tipo="Num" onblur="format(this)" required message="El No. de Titulos es un campo obligatorio" onblur="calculaImporte(this.value,txtPrecio.value);"/>
            </td>
            <td width="15%">
              <input type="text" name="txtPrecio" id="txtPrecio" size="10" tipo="MoneyComas" onchange="format(this)" prec="100.100" reqPrecValue required message="El Precio es un campo obligatorio" onblur="calculaImporte(this.value,txtNoTitulos.value);"/>
            </td>
            <td width="15%">
              <input type="text" name="txtImporte" id="txtImporte" size="10" prec="100.2" tipo="valMoneyComas"  reqPrecValue required message="El Importe es un campo obligatorio" onblur="calculaPrecio(this.value,txtNoTitulos.value);"/>
            </td>
            <td width="10%">&nbsp;</td>
          </tr>
          <tr>
