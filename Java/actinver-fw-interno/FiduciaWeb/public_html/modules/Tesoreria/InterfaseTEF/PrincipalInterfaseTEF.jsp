<form name="frmDatosInterfaseTEF" id="frmDatosInterfaseTEF">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
    <tr>
      <td align="center" height="100%" class="titulo">Interfase TEF</td>
    </tr>
    <tr>
      <td height="100%">&nbsp;</td>
    </tr>
        ...
        <table width="90%" align="center" class="texto">
          ...
          <tr valign="middle">
            ...
            <td align="right" width="3%">
              <input type="radio" name="chkFechaRecepcion" id="chkFechaRecepcion1" class="radio" required message="La Fecha de Recepción es un campo obligatorio"/>
            </td>
          ...
          <tr valign="middle">
            ...
            <td align="right" nowrap width="3%">
              <input type="radio" name="chkFechaRecepcion" id="chkFechaRecepcion2" class="radio"/>
            </td>
    ...
    <tr>
      <td align="center">&nbsp;
        <input type="button" value="Aceptar" name="cmdAceptar" id="cmdAceptar" class="boton" onclick="ejecutaStoreInterfaseTEF();"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="button" value="Limpiar" name="cmdLimpiar" id="cmdLimpiar" class="boton" onclick="onButtonClick('Tesoreria.InterfaseTEF.PrincipalInterfaseTEF','');"/>
      </td>
    </tr>
  </table>
</form>
