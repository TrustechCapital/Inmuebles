<FORM name="frmDatosContactosFideicomisosConsulta" id="frmDatosContactosFideicomisosConsulta" onsubmit="">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
      ...
      <tr>
        <td align="center" height="100%" class="titulo">Men&uacute; de Notificaciones</td>
      </tr>
      <tr>
        <td height="100%">&nbsp;</td>
      </tr>
      <tr>
        <td height="100%">
          <table align="center" class="texto" width="100%">
            ...
            <tr>
              <td width="30%">&nbsp;</td>
              <td width="15%">Tipo de Contacto</td>
              <td width="15%">
                <select size="1" name="paramTContac" id="paramTContac" ref="claves" fun="loadComboElement" keyValue="cveDescClaveTC" theValue="cveDescClaveTC" next="" param=""/> <!-- Falta definir la clave a usar (clavesCombo MAX +2 )-->
              </td>
              <td>&nbsp;</td>
              <td width="25%">&nbsp;</td>
            </tr>
