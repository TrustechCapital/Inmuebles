<FORM name="frmCondonacionHonorariosQ" id="frmCondonacionHonorariosQ" onsubmit="">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
      <tr>
        <td align="center" height="100%" class="titulo">Condonaci&oacute;n Quebrantos</td>
      </tr>
      <tr>
        <td height="100%">&nbsp;</td>
      </tr>
          ...
          <table width="90%" align="center" class="texto" border="0">
            ...
            <tr>
              <td width="15%" align="center" colspan="4">&nbsp;
                ...
                <input type="BUTTON" value="Limpiar" name="cmdLimpiar" size="20%" class="boton" onclick="RF(GI('frmCondonacionHonorariosQ'));"/>
              </td>
            </tr>
            <tr>
