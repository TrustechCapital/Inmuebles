...
<input type="hidden" id="template" name="template" value="/xml/Reportes/Honorarios/PrimerRecordatorioM.xsl"/>
...
<table border="0" cellpadding="1" class="texto" cellspacing="5" width="100%">
  <tr>
    <td>Periodicidad</td>
    <td>
      <select id="paramPeriodicidad" name="paramPeriodicidad" onchange="PrimerRecordatorio(this);" required>
  ...
  <tr>
    ...
    <td>
      ...
      <input type="hidden" id="paramTipoAviso" name="paramTipoAviso" tipo="Numero" value="2"/>
    </td>
  </tr>  
</table>
