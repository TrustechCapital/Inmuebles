//Creo que solo falta cambiar el catalogo a consultar - Yair
...
////////////////////////////////////////////////////////////////////
//CARGA LA SEGUNDA PANTALLA (PrincipalCondonacionHonorariosQ)
function cargaPrincipalCondonacionHonorariosQ() {
  if (pkInfo==null)
  ...
  else
  {
    numPantalla = 1;
    showWaitLayer();
    var urlCliente = ctxRoot + "/modules/Honorarios/PrincipalCondonacionHonorariosQuebrantos.do";
...
function despliegaPantalla(obj, result) {
  ...
  fvCondonacion.setup({
    formName      : "frmCondonacionHonorariosQ",
    tipoAlert     : 1,
...
function catLoaded() {
  ...
  SA(GI("frmCondonacionHonorariosQ").decNumContrato, "LKD", "true");
  SA(GI("frmCondonacionHonorariosQ").decNumContrato, "disabled", "true");
