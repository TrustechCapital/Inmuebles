      ...
      <td height="100%">
        <table align="center" class="texto">
          <!--tr>
            ...
            <td>
              <input type="text" name="paramIdEmisor" id="paramIdEmisor" size="10" maxlength="10"   />
            </td>
            <td width="5%">&nbsp;</td>
          </tr-->
          <tr>
            ...
            <td width="7%">Id. RC</td>
            <td>
              <input type="text" name="paramEmisor" id="paramEmisor" size="10" maxlength="5" onblur="upperRC(this);cargaFisos(this);"/>
            </td>
            <td width="5%">&nbsp;</td>
          </tr>
          <tr>
            ...
            <td>
              <select size="1" name="paramNumFideicomiso" id="paramNumFideicomiso" ref="emision.conETEmisorFideicomiso" fun="loadComboElement" keyValue="idFideicomiso" theValue="descFideicomiso" next="paramTipoEmisor" param="cmbFideicomiso" ><!--   onblur="determinaNumEmision(GI('eemiIdPrograma'),this,this);" onchange="cargaComboFideicomiso(this,GI('eemiNomEmisor'),false,0);" required message="El Fideicomiso es un campo obligatorio"-->
            ...
            <td colspan="4">
              <table border="0" cellpadding="0" cellspacing="0">
                <tr class="cabeceras" align="left">
                  ...
                  <!--td width="120" nowrap>Secuencial</td-->
                  <td width="120" nowrap>Id. RC</td>
                  <td width="200" nowrap>Nombre Emisor</td>
                  <td width="80" nowrap>No. Fideicomiso</td>
              ...
              <div style="height:150px; overflow:auto; position:relative; vertical-align:top; width:823px;">
                <table border="0" cellpadding="0" cellspacing="0" class="texto" id="tblReg" dataInfo="arrTblDat" keys="esorIdEmsisor,efsoIdFideicomiso" fun="clickTabla" radioWidth="23px">
                </table>
              </div>
            </td>
          </tr>
