...
import mx.gob.nafin.fiduciario.common.beans.CatalogInfoBean;
...
public class CatalogManagerController extends JsonActionController {
     ...
     * definida el el objeto @see mx.gob.nafin.fiduciario.common.beans.CatalogInfoBean que se debe de enviar como parte de la cadena json
     * @throws java.lang.Exception Cuando no es posible dar de alta el elemento
     * @return Un bean de error @see mx.gob.nafin.fiduciario.common.beans.ErrorBean que indica el estado de la operacion dentro
