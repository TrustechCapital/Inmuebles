...
public class AccessController extends JsonActionController {
    ...
    public ModelAndView validaAcceso(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        AccessDataBean accesRequest = new AccessDataBean(request.getParameter("username"),
        ...
        try {
            ...
            logger.log(this, Thread.currentThread(), LoggingService.LEVEL.DEBUG, "UserServiceResponse: " + userServiceResponse);
            ...
            switch (userServiceResponse) {
                ...
                case 0: //Usuario valido
                    logger.log(this, Thread.currentThread(), LoggingService.LEVEL.DEBUG, 
                                   "User Service Response Valido: " + userServiceResponse + 
                                   " User: " + accesRequest.getUsername() + 
                                   " Password: " + accesRequest.getPassword() +
                                   " Tipo: " + userServiceResponse
                               );            
                    accessResponse.setValid(true);
                    logger.log(this, Thread.currentThread(), LoggingService.LEVEL.DEBUG, 
                               "User Service Response Valido 2: " + userServiceResponse + 
                               " User: " + accesRequest.getUsername() + 
                               " Password: " + accesRequest.getPassword() +
                               " Tipo: " + userServiceResponse
                           );                  
                ...
                logger.log(this, Thread.currentThread(), LoggingService.LEVEL.DEBUG, 
                           "User Service Response Valido 3: " + userServiceResponse + 
                           " User: " + accesRequest.getUsername() + 
                           " Password: " + accesRequest.getPassword() +
                           " Tipo: " + userServiceResponse
                       );  
                ...
                logger.log(this, Thread.currentThread(), LoggingService.LEVEL.DEBUG, 
                           "User Service Response Valido 4: " + userServiceResponse + 
                           " User: " + accesRequest.getUsername() + 
                           " Password: " + accesRequest.getPassword() +
                           " Tipo: " + userServiceResponse
                       );           
                    ...
                    logger.log(this, Thread.currentThread(), LoggingService.LEVEL.DEBUG, 
                               "User Service Response Valido 5: " + userServiceResponse + 
                               " User: " + accesRequest.getUsername() + 
                               " Password: " + accesRequest.getPassword() +
                               " Tipo: " + userServiceResponse
                           );                
...
/*                default:
            ...
            logger.log(this, Thread.currentThread(), LoggingService.LEVEL.DEBUG, 
                       "User Service Response Antes de isValid: " + userServiceResponse + 
                       " User: " + accesRequest.getUsername() + 
                       " Password: " + accesRequest.getPassword() +
                       " Tipo: " + userServiceResponse
                   );                
            ...
            logger.log(this, Thread.currentThread(), LoggingService.LEVEL.DEBUG, 
                       "User Service Response Despues de isValid: " + userServiceResponse + 
                       " User: " + accesRequest.getUsername() + 
                       " Password: " + accesRequest.getPassword() +
                       " Tipo: " + userServiceResponse
                   );                
    ...
    private void setSessionAttributes(HttpSession session, UserInfoBean userInfo, Object empresas[])  throws Exception  {
        try{        
            ...
            logger.log(this, Thread.currentThread(), LoggingService.LEVEL.ERROR, "setSessionAttributes Error: " + userInfo ,e);
            e. printStackTrace();
        }
    }
