...
@PrimaryKey(constraintName = "PARPATEXH_PK", columns = {"PTX_NUM_FOLIO_INST", "PTX_SUB_CONTRATO", "PTX_SUB_PROGRAMA", "PTX_BENEFICIARIO", "PTX_NUM_CONTRATO", "PTX_NUM_TERCERO"}, sequences = { "MANUAL" })
public class Parpatexh extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM PARPATEXH ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE PARPATEXH SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO PARPATEXH ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM PARPATEXH WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Parpatexh instance = (Parpatexh)compareWith;
  ...
  public Object selectAsObject() {
    Parpatexh result = new Parpatexh();
