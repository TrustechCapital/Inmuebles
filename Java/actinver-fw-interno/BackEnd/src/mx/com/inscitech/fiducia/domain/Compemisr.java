...
public class Compemisr extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM COMPEMISR ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE COMPEMISR SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO COMPEMISR ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM COMPEMISR WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Compemisr instance = (Compemisr)compareWith;
  ...
  public Object selectAsObject() {
    Compemisr result = new Compemisr();
