...
@PrimaryKey(constraintName = "EXPEDIENH_PK", columns = {"EXP_NUM_EXPEDIENTE", "EXP_NUM_CONTRATO"}, sequences = { "MANUAL" })
public class Expedienh extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM EXPEDIENH ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE EXPEDIENH SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO EXPEDIENH ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM EXPEDIENH WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Expedienh instance = (Expedienh)compareWith;
  ...
  public Object selectAsObject() {
    Expedienh result = new Expedienh();
