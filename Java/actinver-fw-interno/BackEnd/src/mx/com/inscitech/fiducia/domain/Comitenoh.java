...
@PrimaryKey(constraintName = "COMITENOH_PK", columns = {"CON_NUM_CONTRATO"}, sequences = { "MAX" })
public class Comitenoh extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM COMITENOH ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE COMITENOH SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO COMITENOH ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM COMITENOH WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Comitenoh instance = (Comitenoh)compareWith;
  ...
  public Object selectAsObject() {
    Comitenoh result = new Comitenoh();
