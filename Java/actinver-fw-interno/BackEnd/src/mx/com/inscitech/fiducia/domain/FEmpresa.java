...
public class FEmpresa extends DomainObject {
  ...
  public boolean doCompare(Object compareWith) {
    ...
    if(equalObjects && !this.getEmpNumEmpresa().equals(instance.getEmpNumEmpresa())) equalObjects = false;
    if(equalObjects && !this.getEmpNomEmpresa().equals(instance.getEmpNomEmpresa())) equalObjects = false;
    if(equalObjects && !this.getEmpNomArea().equals(instance.getEmpNomArea())) equalObjects = false;
    if(equalObjects && !this.getEmpDireccion().equals(instance.getEmpDireccion())) equalObjects = false;
    if(equalObjects && !this.getEmpNomAutoriza().equals(instance.getEmpNomAutoriza())) equalObjects = false;
    if(equalObjects && !this.getEmpNomFirma().equals(instance.getEmpNomFirma())) equalObjects = false;
    if(equalObjects && !this.getEmpIdioma().equals(instance.getEmpIdioma())) equalObjects = false;
    if(equalObjects && !this.getEmpEstilo().equals(instance.getEmpEstilo())) equalObjects = false;
    if(equalObjects && !this.getEmpFecCambio().equals(instance.getEmpFecCambio())) equalObjects = false;
    if(equalObjects && !this.getEmpLlaveEmpresa().equals(instance.getEmpLlaveEmpresa())) equalObjects = false;
    if(equalObjects && !this.getEmpNomAutoriza2().equals(instance.getEmpNomAutoriza2())) equalObjects = false;
    if(equalObjects && !this.getEmpNomFirma2().equals(instance.getEmpNomFirma2())) equalObjects = false;
    if(equalObjects && !this.getEmpLeyendaEdosfin().equals(instance.getEmpLeyendaEdosfin())) equalObjects = false;
    if(equalObjects && !this.getEmpLeyendaEdores().equals(instance.getEmpLeyendaEdores())) equalObjects = false;
    if(equalObjects && !this.getEmpConfirma().equals(instance.getEmpConfirma())) equalObjects = false;
    if(equalObjects && !this.getEmpInterValores().equals(instance.getEmpInterValores())) equalObjects = false;
    if(equalObjects && !this.getEmpNombreValores().equals(instance.getEmpNombreValores())) equalObjects = false;
    if(equalObjects && !this.getEmpInterConta().equals(instance.getEmpInterConta())) equalObjects = false;
    if(equalObjects && !this.getEmpNombreConta().equals(instance.getEmpNombreConta())) equalObjects = false;
    if(equalObjects && !this.getEmpInterLavado().equals(instance.getEmpInterLavado())) equalObjects = false;
    if(equalObjects && !this.getEmpNombreLavado().equals(instance.getEmpNombreLavado())) equalObjects = false;
    if(equalObjects && !this.getEmpInterVector().equals(instance.getEmpInterVector())) equalObjects = false;
    if(equalObjects && !this.getEmpNombreVector().equals(instance.getEmpNombreVector())) equalObjects = false;
    if(equalObjects && !this.getEmpInterClientes().equals(instance.getEmpInterClientes())) equalObjects = false;
    if(equalObjects && !this.getEmpNombreClientes().equals(instance.getEmpNombreClientes())) equalObjects = false;
    if(equalObjects && !this.getEmpInterCreditos().equals(instance.getEmpInterCreditos())) equalObjects = false;
    if(equalObjects && !this.getEmpNombreCreditos().equals(instance.getEmpNombreCreditos())) equalObjects = false;
    if(equalObjects && !this.getEmpProcedimiento().equals(instance.getEmpProcedimiento())) equalObjects = false;
    return equalObjects;
  }
