...
@PrimaryKey(constraintName = "DEPOSIT_PK", columns = {"DPO_FOLIO_RCP", "DPO_FOLIO_OPERA", "DPO_CVE_TIPO_DEP"}, sequences = { "MANUAL" })
public class Deposit extends DomainObject {
  ...
  public boolean doCompare(Object compareWith) {
    ...
    if(equalObjects && !this.getDpoFolioRcp().equals(instance.getDpoFolioRcp())) equalObjects = false;
    if(equalObjects && !this.getDpoFolioOpera().equals(instance.getDpoFolioOpera())) equalObjects = false;
    if(equalObjects && !this.getDpoNumOperacion().equals(instance.getDpoNumOperacion())) equalObjects = false;
    if(equalObjects && !this.getDpoNumSecOpera().equals(instance.getDpoNumSecOpera())) equalObjects = false;
    if(equalObjects && !this.getDpoNumModulo().equals(instance.getDpoNumModulo())) equalObjects = false;
    if(equalObjects && !this.getDpoNumTransac().equals(instance.getDpoNumTransac())) equalObjects = false;
    if(equalObjects && !this.getDpoNumContrato().equals(instance.getDpoNumContrato())) equalObjects = false;
    if(equalObjects && !this.getDpoSubContrato().equals(instance.getDpoSubContrato())) equalObjects = false;
    if(equalObjects && !this.getDpoSubPrograma().equals(instance.getDpoSubPrograma())) equalObjects = false;
    if(equalObjects && !this.getDpoNumPersFid().equals(instance.getDpoNumPersFid())) equalObjects = false;
    if(equalObjects && !this.getDpoFolioOperSis().equals(instance.getDpoFolioOperSis())) equalObjects = false;
    if(equalObjects && !this.getDpoBenefXtercer().equals(instance.getDpoBenefXtercer())) equalObjects = false;
    if(equalObjects && !this.getDpoCotizacion().equals(instance.getDpoCotizacion())) equalObjects = false;
    if(equalObjects && !this.getDpoNomPersFid().equals(instance.getDpoNomPersFid())) equalObjects = false;
    if(equalObjects && !this.getDpoTipoPersFid().equals(instance.getDpoTipoPersFid())) equalObjects = false;
    if(equalObjects && !this.getDpoCveTipoDep().equals(instance.getDpoCveTipoDep())) equalObjects = false;
    if(equalObjects && !this.getDpoImpDeposito().equals(instance.getDpoImpDeposito())) equalObjects = false;
    if(equalObjects && !this.getDpoNumMoneda().equals(instance.getDpoNumMoneda())) equalObjects = false;
    if(equalObjects && !this.getDpoNumCheque().equals(instance.getDpoNumCheque())) equalObjects = false;
    if(equalObjects && !this.getDpoCveTipoCta().equals(instance.getDpoCveTipoCta())) equalObjects = false;
    if(equalObjects && !this.getDpoNumBanco().equals(instance.getDpoNumBanco())) equalObjects = false;
    if(equalObjects && !this.getDpoNomBanco().equals(instance.getDpoNomBanco())) equalObjects = false;
    if(equalObjects && !this.getDpoNumPlaza().equals(instance.getDpoNumPlaza())) equalObjects = false;
    if(equalObjects && !this.getDpoNomPlaza().equals(instance.getDpoNomPlaza())) equalObjects = false;
    if(equalObjects && !this.getDpoNumPais().equals(instance.getDpoNumPais())) equalObjects = false;
    if(equalObjects && !this.getDpoCtaBanxico().equals(instance.getDpoCtaBanxico())) equalObjects = false;
    if(equalObjects && !this.getDpoDirAperCta().equals(instance.getDpoDirAperCta())) equalObjects = false;
    if(equalObjects && !this.getDpoCodigoTrans().equals(instance.getDpoCodigoTrans())) equalObjects = false;
    if(equalObjects && !this.getDpoConcepto().equals(instance.getDpoConcepto())) equalObjects = false;
    if(equalObjects && !this.getDpoNumCuenta().equals(instance.getDpoNumCuenta())) equalObjects = false;
    if(equalObjects && !this.getDpoFecha().equals(instance.getDpoFecha())) equalObjects = false;
    if(equalObjects && !this.getDpoNomInstitu().equals(instance.getDpoNomInstitu())) equalObjects = false;
    if(equalObjects && !this.getDpoNumRefe().equals(instance.getDpoNumRefe())) equalObjects = false;
    if(equalObjects && !this.getDpoNumSucursal().equals(instance.getDpoNumSucursal())) equalObjects = false;
    if(equalObjects && !this.getDpoNomSucursal().equals(instance.getDpoNomSucursal())) equalObjects = false;
    if(equalObjects && !this.getDpoNumIniciativa().equals(instance.getDpoNumIniciativa())) equalObjects = false;
    if(equalObjects && !this.getDpoNumCtam().equals(instance.getDpoNumCtam())) equalObjects = false;
    if(equalObjects && !this.getDpoNumScta().equals(instance.getDpoNumScta())) equalObjects = false;
    if(equalObjects && !this.getDpoNumSscta().equals(instance.getDpoNumSscta())) equalObjects = false;
    if(equalObjects && !this.getDpoNumSsscta().equals(instance.getDpoNumSsscta())) equalObjects = false;
    if(equalObjects && !this.getDpoNumEnte().equals(instance.getDpoNumEnte())) equalObjects = false;
    if(equalObjects && !this.getDpoNomArea().equals(instance.getDpoNomArea())) equalObjects = false;
    if(equalObjects && !this.getDpoEntidadFin().equals(instance.getDpoEntidadFin())) equalObjects = false;
    if(equalObjects && !this.getDpoContratoInter().equals(instance.getDpoContratoInter())) equalObjects = false;
    if(equalObjects && !this.getDpoPolitica().equals(instance.getDpoPolitica())) equalObjects = false;
    if(equalObjects && !this.getDpoAnoRcp().equals(instance.getDpoAnoRcp())) equalObjects = false;
    if(equalObjects && !this.getDpoMesRcp().equals(instance.getDpoMesRcp())) equalObjects = false;
    if(equalObjects && !this.getDpoDiaRcp().equals(instance.getDpoDiaRcp())) equalObjects = false;
    if(equalObjects && !this.getDpoAnoAltaReg().equals(instance.getDpoAnoAltaReg())) equalObjects = false;
    if(equalObjects && !this.getDpoMesAltaReg().equals(instance.getDpoMesAltaReg())) equalObjects = false;
    if(equalObjects && !this.getDpoDiaAltaReg().equals(instance.getDpoDiaAltaReg())) equalObjects = false;
    if(equalObjects && !this.getDpoAnoUltMod().equals(instance.getDpoAnoUltMod())) equalObjects = false;
    if(equalObjects && !this.getDpoMesUltMod().equals(instance.getDpoMesUltMod())) equalObjects = false;
    if(equalObjects && !this.getDpoDiaUltMod().equals(instance.getDpoDiaUltMod())) equalObjects = false;
    if(equalObjects && !this.getDpoCveStDeposi().equals(instance.getDpoCveStDeposi())) equalObjects = false;
    if(equalObjects && !this.getDpoConiva().equals(instance.getDpoConiva())) equalObjects = false;
    if(equalObjects && !this.getDpoImpIva().equals(instance.getDpoImpIva())) equalObjects = false;
    if(equalObjects && !this.getDpoFolioAgend().equals(instance.getDpoFolioAgend())) equalObjects = false;
    if(equalObjects && !this.getDpoRubro().equals(instance.getDpoRubro())) equalObjects = false;
    return equalObjects;
  }
