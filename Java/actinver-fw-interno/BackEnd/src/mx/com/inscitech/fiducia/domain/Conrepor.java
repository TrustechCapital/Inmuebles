...
@PrimaryKey(constraintName = "CONREPOR_PK", columns = {"CRE_NUM_CONTRATO", "CRE_SUB_CONTRATO", "CRE_CONTRATO_INTER", "CRE_FOLIO_REPORTO", "CRE_ENTIDAD_FIN"}, sequences = { "MANUAL" })
public class Conrepor extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM CONREPOR ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE CONREPOR SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO CONREPOR ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM CONREPOR WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Conrepor instance = (Conrepor)compareWith;
