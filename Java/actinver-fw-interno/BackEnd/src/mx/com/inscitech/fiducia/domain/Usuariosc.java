...
public class Usuariosc extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM USUARIOSC ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE USUARIOSC SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO USUARIOSC ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM USUARIOSC WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Usuariosc instance = (Usuariosc)compareWith;
  ...
  public Object selectAsObject() {
    Usuariosc result = new Usuariosc();
