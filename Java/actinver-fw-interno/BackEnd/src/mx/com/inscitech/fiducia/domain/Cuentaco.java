...
@PrimaryKey(constraintName = "CUENTACO_PK", columns = {"CUE_NUM_CTAM", "CUE_NUM_SCTA", "CUE_NUM_SSCTA", "CUE_NUM_SSSCTA", "CUE_NUM_SSSSCTA", "CUE_NUM_SSSSSCTA"}, sequences = { "MANUAL" })
public class Cuentaco extends DomainObject {
  ...
  BigDecimal cueSat = new BigDecimal(0L);
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM CUENTACO ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE CUENTACO SET ";
    ...
    conditions += " AND CUE_NUM_CTAM = ?";
    pkValues.add(this.getCueNumCtam());
    conditions += " AND CUE_NUM_SCTA = ?";
    pkValues.add(this.getCueNumScta());
    conditions += " AND CUE_NUM_SSCTA = ?";
    pkValues.add(this.getCueNumSscta());
    conditions += " AND CUE_NUM_SSSCTA = ?";
    pkValues.add(this.getCueNumSsscta());
    conditions += " AND CUE_NUM_SSSSCTA = ?";
    pkValues.add(this.getCueNumSssscta());
    conditions += " AND CUE_NUM_SSSSSCTA = ?";
    pkValues.add(this.getCueNumSsssscta());
    fields += " CUE_NUM_AUX1 = ?, ";
    values.add(this.getCueNumAux1());
    fields += " CUE_NUM_AUX2 = ?, ";
    values.add(this.getCueNumAux2());
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO CUENTACO ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM CUENTACO WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Cuentaco instance = (Cuentaco)compareWith;
