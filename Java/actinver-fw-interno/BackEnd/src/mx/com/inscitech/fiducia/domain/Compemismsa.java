...
@PrimaryKey(constraintName = "COMPEMISMSA_PK", columns = {"CPE_NOM_PIZARRA", "CPE_NUM_SERIE_EMIS", "CPE_NUM_CUPON_VIG", "CPE_DIA_COMPRA", "CPE_SEC_DIA_COMPRA", "CPE_SUB_CONTRATO", "CPE_CONTRATO_INTER", "CPE_NUM_CONTRATO", "CPE_ENTIDAD_FIN"}, sequences = { "MANUAL" })
public class Compemismsa extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM COMPEMISMSA ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE COMPEMISMSA SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO COMPEMISMSA ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM COMPEMISMSA WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Compemismsa instance = (Compemismsa)compareWith;
  ...
  public Object selectAsObject() {
    Compemismsa result = new Compemismsa();
