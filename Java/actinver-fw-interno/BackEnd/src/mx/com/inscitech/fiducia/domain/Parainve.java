...
@PrimaryKey(constraintName = "PARAINVE_PK", columns = {"PAR_NUM_SUB_CONT", "PAR_NUM_ENTID_FIN", "PAR_CONTRATO_INTER", "PAR_CVE_CPA_VTA", "PAR_CVE_TIPO_MERCA", "PAR_NUM_INSTRUME", "PAR_NUM_PLAZO", "PAR_NUM_CONTRATO"}, sequences = { "MANUAL" })
public class Parainve extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM PARAINVE ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE PARAINVE SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO PARAINVE ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM PARAINVE WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Parainve instance = (Parainve)compareWith;
