...
@PrimaryKey(constraintName = "CARTERAH_PK", columns = {"CAR_NUM_CONTRATO", "CAR_CVE_PERS_FID", "CAR_NUM_PERS_FID", "CAR_CVE_TIPO_HONO"}, sequences = { "MANUAL" })
public class Carterah extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM CARTERAH ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE CARTERAH SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO CARTERAH ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM CARTERAH WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Carterah instance = (Carterah)compareWith;
