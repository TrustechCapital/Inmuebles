...
@PrimaryKey(constraintName = "F_CONDATO_PK", columns = {"COND_ID_PERSONA", "COND_ID_FIDEICOMISO", "COND_ID_TIPO", "COND_ID_NUM_TIPO", "COND_ID_CONCEPTO", "COND_ID_SCONCEPTO", "COND_ID_SSCONCEPTO"}, sequences = { "MANUAL" })
public class FCondato extends DomainObject {

  String condIdPersona = null;
  BigDecimal condIdFideicomiso = null;
  ...
  public void setCondIdFideicomiso(BigDecimal condIdFideicomiso) {
    this.condIdFideicomiso = condIdFideicomiso;
  }

  public BigDecimal getCondIdFideicomiso() {
    return this.condIdFideicomiso;
  }
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM F_CONDATO ";
    ...
    if(this.getCondIdFideicomiso() != null && this.getCondIdFideicomiso().longValue() == -999) {
      conditions += " AND COND_ID_FIDEICOMISO IS NULL";
    } else if(this.getCondIdFideicomiso() != null) {
      conditions += " AND COND_ID_FIDEICOMISO = ?";
      values.add(this.getCondIdFideicomiso());
    }
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE F_CONDATO SET ";
    ...
    conditions += " AND COND_ID_FIDEICOMISO = ?";
    pkValues.add(this.getCondIdFideicomiso());
    conditions += " AND COND_ID_TIPO = ?";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO F_CONDATO ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM F_CONDATO WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    FCondato instance = (FCondato)compareWith;
    boolean equalObjects = true;
    if(equalObjects && !this.getCondIdPersona().equals(instance.getCondIdPersona())) equalObjects = false;
    if(equalObjects && !this.getCondIdFideicomiso().equals(instance.getCondIdFideicomiso())) equalObjects = false;
  ...
  public Object selectAsObject() {
    FCondato result = new FCondato();
    DataRow objectData = null;
    objectData = selectAsDataRow();

    result.setCondIdPersona((String)objectData.getData("COND_ID_PERSONA"));
    result.setCondIdFideicomiso((BigDecimal)objectData.getData("COND_ID_FIDEICOMISO"));
