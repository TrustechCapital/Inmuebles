...
public class nFinanciera extends nFiducia {
 ...
 Genera el  Reporte de Situaci�n Program�tico Presupuestal de los FOSEG'S
 AUTOR: EOM Y MVM
 Modificada por: Jannett Jim�nez Ruiz
 Fecha:01/09/2004
...
*/
    ...
    public synchronized String getPresupuestalFoseg(String[] sData) {
        ...
        try {
            ...
            i = 0;
            sTexto.append("<title>ESTADO DE CUENTA, Fideicomiso:  \"" + sData[0] + "\" Ejercicio: " + sData[2] + "\" " +
                          "</title>"
                          // +  "<link rel=\"stylesheet\" href=\"styles/nafin.css\" type=\"text/css\">"
                          + "</head>" + "<body onLoad=\"Opcion();\">" + "<table width=\"100%\" border=\"0\">" +
                          "<tr> " + "<td  rowspan=\"4\" >&nbsp;</td>" +
                          ...
                          "</tr>" + "<tr> " +
                          "<td align=center style=\"font-family: Arial;	font-size: 12px;color: #000000;font-weight: bold;\" colspan=14> FIDEICOMISO&nbsp;&nbsp;" +
                          sData[0] + " - " + sData[1] + "&nbsp;</td>" + "</tr>" + "<tr> " +
                          "<td align=center style=\"font-family: Arial;	font-size: 12px;color: #000000;font-weight: bold;\" colspan=14> Situaci�n Programatica Presupuestal al " +
                          sData[3] + "</td>" + "</tr>" + "<tr>" + "<td colspan=19 >&nbsp;</td>" + "</tr>" + "<tr>" +
                          "<td>&nbsp;</td><td colspan=18 style=\"font-family: Arial;	font-size: 12px;color: #000000;font-weight: bold;\">&nbsp;&nbsp;&nbsp;EJERCICIO: " +
                          sData[2] + "</td>" + "</tr>" + "<tr class=tituloRP9  bgcolor=\"#CCCCCC\"> " +
                          "<td align=center  bgcolor=\"#FFFFFF\"> &nbsp;</td>" +
                          "<td rowspan=\"2\" align=center>EJE</td>" + "<td rowspan=\"2\" align=center>PROG.</td>" +
                          "<td rowspan=\"2\" align=center>PROY.</td>" + "<td rowspan=\"2\" align=center>ACC.</td>" +
                          ...
                          "<td rowspan=\"2\" align=center>TOTAL</td>" + "</tr>" +
                          "<tr class=tituloRP9  bgcolor=\"#CCCCCC\"> " +
                          "<td align=center bgcolor=\"#FFFFFF\"> &nbsp;</td>" + "<td  align=center>ASIGNADO</td>" +
                          "<td  align=center>EJERCIDO</td>" + "<td  align=center>COMPROMETIDO</td>" +
                          "<td  align=center>DISPONIBLE</td>" + "<td  align=center>ASIGNADO</td>" +
                          "<td  align=center>EJERCIDO</td>" + "<td  align=center>COMPROMETIDO</td>" +
                          "<td  align=center>DISPONIBLE</td>" + "<td  align=center>ASIGNADO</td>" +
                          "<td  align=center>EJERCIDO</td>" + "<td  align=center>COMPROMETIDO</td>" +
                          "<td  align=center>DISPONIBLE</td>" + "</tr>");
            ...
            sQuery =
                "select " + " TO_CHAR(SAL_NUM_SCTA,'00'),TO_CHAR(SAL_NUM_SSCTA,'00')," +
                " TO_CHAR(SAL_NUM_SSSCTA,'00')," + " TO_CHAR(SAL_NUM_SSSSCTA,'0000')," + " CUE_NOM_CTA" +
                " from saldos,cuentaco where" + " SAL_NUM_AUX1=" + sData[0] + " and SAL_NUM_CTAM=7000" +
                " and SAL_NUM_SSSSSCTA=0" + " and SAL_NUM_CTAM=CUE_NUM_CTAM" + " and SAL_NUM_SCTA=CUE_NUM_SCTA" +
                " and SAL_NUM_SSCTA=CUE_NUM_SSCTA" + " and SAL_NUM_SSSCTA=CUE_NUM_SSSCTA" +
                " and SAL_NUM_SSSSCTA=CUE_NUM_SSSSCTA" + " and SAL_NUM_SSSSSCTA=CUE_NUM_SSSSSCTA";

            sQueryOrdena =
                " group by " + " SAL_NUM_SCTA,SAL_NUM_SSCTA,SAL_NUM_SSSCTA," + " SAL_NUM_SSSSCTA,CUE_NOM_CTA" +
            ...
            for (i = 0; i < j; i++) {
                ...
                sTexto.append("<td align=right> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][5]).doubleValue()) + "</td>");
                sTexto.append("<td align=right> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][6]).doubleValue()) + "</td>");
                sTexto.append("<td align=right> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][7]).doubleValue()) + "</td>");
                sTexto.append("<td align=right class=\"tituloRP\"> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][8]).doubleValue()) + "</td>");
                sTexto.append("<td align=right> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][9]).doubleValue()) + "</td>");
                sTexto.append("<td align=right> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][10]).doubleValue()) + "</td>");
                sTexto.append("<td align=right> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][11]).doubleValue()) + "</td>");
                sTexto.append("<td  align=right class=\"tituloRP\"> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][12]).doubleValue()) + "</td>");
                sTexto.append("<td align=right> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][13]).doubleValue()) + "</td>");
                sTexto.append("<td align=right> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][14]).doubleValue()) + "</td>");
                sTexto.append("<td align=right> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][15]).doubleValue()) + "</td>");
                sTexto.append("<td  align=right class=\"tituloRP\"> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][16]).doubleValue()) + "</td>");
                sTexto.append("<td  align=right class=\"tituloRP\"> " +
                              dfFormat.format(Double.valueOf(scad_conceptos[i][16]).doubleValue() +
 ...
 Autor:Betzabe Rodriguez
	...
	// 5 - Municipio
	// 6 - Inversionista
 Moodificada por: Jannett Jim�nez Ruiz
 Fecha:01/09/2004
*/
    ...
    public String getReporteCtasInd(String[] sData, String[] sNomNivel) {
        try {
            ...
            sTexto += "</title>";
            sTexto += "<link rel=\"stylesheet\" href=\"styles/nafin.css\" type=\"text/css\">";
            sTexto += "</head>";
            ...
            sTexto +=
                "<tr><td colspan=\"2\">&nbsp;</td></tr><tr><td colspan=\"2\" align=\"center\" class=\"texto\"><b>" +
                sData[1] + "</b></td></tr>";
            sTexto += "<tr><td colspan=\"2\">&nbsp;</td></tr>";
            sTexto +=
                "<tr><td colspan=\"2\" align=\"left\" class=\"celda03\"><b>" + sNomNivel[1] + ": " + sData[4] +
                "</b></td></tr>";


            if (sData[8].equals("3")) {
                sTexto +=
                    "<tr><td colspan=\"2\" align=\"left\" class=\"celda03\"><b>" + sNomNivel[2] + ": " + sData[5] +
                    "</b></td></tr>";
                sTexto +=
                    "<tr><td colspan=\"2\" align=\"left\" class=\"celda03\"><b>" + sNomNivel[3] + ": " + sData[6] +
                    "</b></td></tr>";
            } else
	...
	*/
            String FechaStr = "01/" + sData[2].substring(3, 5) + "/" + sData[2].substring(6, 10);
            String FechaStr1 =
                sData[3].substring(0, 2) + "/" + sData[3].substring(3, 5) + "/" + sData[3].substring(6, 10);
            stInstrucc = conBD.createStatement();
            String sInstrucc =
                "BEGIN " + "SP_ACT_SAL_CTAS_IND(" + sData[0] + "," + "'" + FechaStr + "'," + "'" + FechaStr1 + "'," +
                "'" + sClave + "'," + "'" + sClave + "'," + "'FALSE'); " + "END;";
            ...
            if (rsQuery.next()) {
                ...
                do {
                    ...
                    sTexto +=
                        "<td align=\"center\" class=\"celda03\">" + dfFormat.format(rsQuery.getDouble(2)) +
                        "</font></td>";
                    sTexto +=
                        "<td align=\"right\" class=\"celda03\">" + dfFormat.format(rsQuery.getDouble(3)) +
                        "</font></td>";
                    sTexto +=
                        "<td align=\"right\" class=\"celda03\">" + dfFormat.format(rsQuery.getDouble(4)) +
                        "</font></td>";
                    sTexto +=
                        "<td align=\"right\" class=\"celda03\">" + dfFormat.format(rsQuery.getDouble(5)) +
                        "</font></td>";
                    sTexto +=
                        "<td align=\"right\" class=\"celda03\">" + dfFormat.format(rsQuery.getDouble(6)) +
                        "</font></td>";

                    if (dParticipa > 0.001) {
                        dSaldoParcial =
                            rsQuery.getDouble(8) + rsQuery.getDouble(3) - rsQuery.getDouble(4) + rsQuery.getDouble(5) -
                            rsQuery.getDouble(6);
                        sTexto +=
                            "<td align=\"right\" class=\"celda03\">" + dfFormat.format(dSaldoParcial) + "</font></td>";
                        sTexto +=
                            "<td align=\"right\" class=\"celda03\">" +
                            dfFormat.format((rsQuery.getDouble(5) - rsQuery.getDouble(6)) * dParticipa / 100.00) +
                            "</font></td>";
                    }

                    sTexto +=
                        "<td align=\"right\" class=\"celda03\">" + dfFormat.format(rsQuery.getDouble(7)) +
                        "</font></td>";
                    sTexto += "</font></td>";
