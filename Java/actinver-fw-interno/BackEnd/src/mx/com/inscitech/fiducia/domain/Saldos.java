...
@PrimaryKey(constraintName = "SALDOS_PK", columns = {"SAL_NUM_AUX1", "SAL_NUM_CTAM", "SAL_NUM_SCTA", "SAL_NUM_SSCTA", "SAL_NUM_SSSCTA", "SAL_NUM_SSSSCTA", "SAL_NUM_SSSSSCTA", "SAL_NUM_AUX2", "SAL_NUM_AUX3"}, sequences = { "MANUAL" })
public class Saldos extends DomainObject {
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM SALDOS WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Saldos instance = (Saldos)compareWith;
