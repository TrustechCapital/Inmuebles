...
public class FAsientosConc extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM F_ASIENTOS_CONC ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE F_ASIENTOS_CONC SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO F_ASIENTOS_CONC ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM F_ASIENTOS_CONC WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    FAsientosConc instance = (FAsientosConc)compareWith;
  ...
  public Object selectAsObject() {
    FAsientosConc result = new FAsientosConc();
