...
@PrimaryKey(constraintName = "PALIQUIDH_PK", columns = {"PAL_NUM_CONTRATO", "PAL_CVE_APLICA_DAT", "PAL_CVE_PERS_FID", "PAL_NUM_PERS_FID"}, sequences = { "MANUAL" })
public class Paliquidh extends DomainObject {
  ...
  public void setPalNumCuenta(BigDecimal palNumCuenta) {
    this.palNumCuenta = palNumCuenta;
  }

  public BigDecimal getPalNumCuenta() {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM PALIQUIDH ";
  ...
  public DMLObject getSelect() {
    ...
    if(this.getPalNumCuenta() != null && this.getPalNumCuenta().longValue() == -999) {
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE PALIQUIDH SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO PALIQUIDH ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM PALIQUIDH WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Paliquidh instance = (Paliquidh)compareWith;
  ...
  public Object selectAsObject() {
    Paliquidh result = new Paliquidh();
    ...
    result.setPalNumCuenta((BigDecimal)objectData.getData("PAL_NUM_CUENTA"));
