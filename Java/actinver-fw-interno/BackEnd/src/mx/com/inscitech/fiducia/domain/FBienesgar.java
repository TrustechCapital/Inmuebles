...
@PrimaryKey(constraintName = "F_BIENESGAR_PK", columns = {"FGRS_ID_FIDEICOMISO", "FGRS_ID_SUBCUENTA", "FORS_ID_GARANTIA"}, sequences = { "MANUAL" })
public class FBienesgar extends DomainObject {
  ...
  public boolean doCompare(Object compareWith) {
    ...
    if(equalObjects && !this.getFgrsIdFideicomiso().equals(instance.getFgrsIdFideicomiso())) equalObjects = false;
    if(equalObjects && !this.getFgrsIdSubcuenta().equals(instance.getFgrsIdSubcuenta())) equalObjects = false;
    if(equalObjects && !this.getForsIdGarantia().equals(instance.getForsIdGarantia())) equalObjects = false;
    if(equalObjects && !this.getForsCveTipoGarantia().equals(instance.getForsCveTipoGarantia())) equalObjects = false;
    if(equalObjects && !this.getForsCveTipoBien().equals(instance.getForsCveTipoBien())) equalObjects = false;
    if(equalObjects && !this.getForsIdentificacion().equals(instance.getForsIdentificacion())) equalObjects = false;
    if(equalObjects && !this.getForsTextoDescrip().equals(instance.getForsTextoDescrip())) equalObjects = false;
    if(equalObjects && !this.getForsTexComentario().equals(instance.getForsTexComentario())) equalObjects = false;
    if(equalObjects && !this.getForsImpBien().equals(instance.getForsImpBien())) equalObjects = false;
    if(equalObjects && !this.getForsMoneda().equals(instance.getForsMoneda())) equalObjects = false;
    if(equalObjects && !this.getForsCveRevalua().equals(instance.getForsCveRevalua())) equalObjects = false;
    if(equalObjects && !this.getForsCvePerValua().equals(instance.getForsCvePerValua())) equalObjects = false;
    if(equalObjects && !this.getForsImpUltValua().equals(instance.getForsImpUltValua())) equalObjects = false;
    if(equalObjects && !this.getForsFecUltValua().equals(instance.getForsFecUltValua())) equalObjects = false;
    if(equalObjects && !this.getForsFecVencimiento().equals(instance.getForsFecVencimiento())) equalObjects = false;
    if(equalObjects && !this.getForsNumEscritura().equals(instance.getForsNumEscritura())) equalObjects = false;
    if(equalObjects && !this.getForsNumNotario().equals(instance.getForsNumNotario())) equalObjects = false;
    if(equalObjects && !this.getForsCveStatus().equals(instance.getForsCveStatus())) equalObjects = false;
    return equalObjects;
  }
