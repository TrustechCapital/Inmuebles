...
import mx.com.inscitech.fiducia.common.beans.MenuItemBean;
...
public class MenuService {
    ...
    private static final String QUERY_MENU =
        "SELECT FUN.FFUN_ID_FUNCION, FUN.FFUN_ID_PADRE, FUN.FFUN_NOM_MENU FFUN_NOM_MENU, FUN.FFUN_NOMBRE_FUNCION FROM " +
    ...
    private static final String QUERY_MENU_NULL =
        "SELECT FUN.FFUN_ID_FUNCION, FUN.FFUN_ID_PADRE, FUN.FFUN_NOM_MENU FFUN_NOM_MENU, FUN.FFUN_NOMBRE_FUNCION FROM " +
        "F_FUNCION FUN, F_PER_FUN PER WHERE FUN.FFUN_ID_FUNCION = PER.FFUN_ID_FUNCION " +
        "AND FUN.FFUN_ID_PADRE IS NULL AND PER.FPER_ID_PERFIL = ? ORDER BY FUN.FFUN_ORDEN";

    private static final String QUERY_HAS_CHILDS =
        "SELECT COUNT(*) AS CHILD_COUNT FROM F_FUNCION FUN WHERE FFUN_ID_PADRE = ?";

    private Connection cn = null;

    private ArrayList<String[]> parche = null;
    ...
    public List getMenuChilds(Integer puestoId, Integer parentId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String menu = rs.getString("FFUN_NOM_MENU");
