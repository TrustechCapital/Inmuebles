...
public class Asientosc extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM ASIENTOSC ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE ASIENTOSC SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO ASIENTOSC ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM ASIENTOSC WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Asientosc instance = (Asientosc)compareWith;
  ...
  public Object selectAsObject() {
    Asientosc result = new Asientosc();
