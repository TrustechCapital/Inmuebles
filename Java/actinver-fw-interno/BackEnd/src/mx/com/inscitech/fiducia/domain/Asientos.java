...
@PrimaryKey(constraintName = "ASIENTOS_PK", columns = {"ASI_FOLIO_OPERA", "ASI_NUM_OPERACION", "ASI_SEC_OPERA", "ASI_SEC_ASIENTO", "ASI_NUM_MODULO", "ASI_TRANSACCION"}, sequences = { "MANUAL" })
public class Asientos extends DomainObject {
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM ASIENTOS WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Asientos instance = (Asientos)compareWith;
