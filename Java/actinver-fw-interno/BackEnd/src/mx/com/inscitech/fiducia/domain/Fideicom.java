...
@PrimaryKey(constraintName = "FIDEICOM_PK", columns = {"FID_NUM_CONTRATO", "FID_FIDEICOMITENTE"}, sequences = { "MANUAL" })
public class Fideicom extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM FIDEICOM ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE FIDEICOM SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO FIDEICOM ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM FIDEICOM WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Fideicom instance = (Fideicom)compareWith;
