...
public class Claves extends DomainObject {
  ...
  public boolean doCompare(Object compareWith) {
    ...
    if(equalObjects && !this.getCveNumClave().equals(instance.getCveNumClave())) equalObjects = false;
    if(equalObjects && !this.getCveNumSecClave().equals(instance.getCveNumSecClave())) equalObjects = false;
    if(equalObjects && !this.getCveDescClave().equals(instance.getCveDescClave())) equalObjects = false;
    if(equalObjects && !this.getCveLiminfClave().equals(instance.getCveLiminfClave())) equalObjects = false;
    if(equalObjects && !this.getCveLimsupClave().equals(instance.getCveLimsupClave())) equalObjects = false;
    if(equalObjects && !this.getCveFormaEmpCve().equals(instance.getCveFormaEmpCve())) equalObjects = false;
    if(equalObjects && !this.getCveAnoAltaReg().equals(instance.getCveAnoAltaReg())) equalObjects = false;
    if(equalObjects && !this.getCveMesAltaReg().equals(instance.getCveMesAltaReg())) equalObjects = false;
    if(equalObjects && !this.getCveDiaAltaReg().equals(instance.getCveDiaAltaReg())) equalObjects = false;
    if(equalObjects && !this.getCveAnoUltMod().equals(instance.getCveAnoUltMod())) equalObjects = false;
    if(equalObjects && !this.getCveMesUltMod().equals(instance.getCveMesUltMod())) equalObjects = false;
    if(equalObjects && !this.getCveDiaUltMod().equals(instance.getCveDiaUltMod())) equalObjects = false;
    if(equalObjects && !this.getCveCveStClave().equals(instance.getCveCveStClave())) equalObjects = false;
    if(equalObjects && !this.getCveParam1().equals(instance.getCveParam1())) equalObjects = false;
    if(equalObjects && !this.getCveDescParam1().equals(instance.getCveDescParam1())) equalObjects = false;
    if(equalObjects && !this.getCveParam2().equals(instance.getCveParam2())) equalObjects = false;
    if(equalObjects && !this.getCveDescParam2().equals(instance.getCveDescParam2())) equalObjects = false;
    if(equalObjects && !this.getCveParam3().equals(instance.getCveParam3())) equalObjects = false;
    if(equalObjects && !this.getCveDescParam3().equals(instance.getCveDescParam3())) equalObjects = false;
    return equalObjects;
  }
