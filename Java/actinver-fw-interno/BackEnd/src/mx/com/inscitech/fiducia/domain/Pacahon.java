...
public class Pacahon extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM PACAHON ";
  ...
  public DMLObject getSelect() {
    ...
    if(this.getPacPeriodoActInpc() != null && "null".equals(this.getPacPeriodoActInpc())) {
      conditions += " AND PAC_PERIODO_ACT_INPC IS NULL";
    } else if(this.getPacPeriodoActInpc() != null) {
      conditions += " AND PAC_PERIODO_ACT_INPC = ?";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO PACAHON ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM PACAHON WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Pacahon instance = (Pacahon)compareWith;
    ...
    if(equalObjects && !this.getPacPeriodoActInpc().equals(instance.getPacPeriodoActInpc())) equalObjects = false;
    return equalObjects;
  }

  public Object selectAsObject() {
    Pacahon result = new Pacahon();
