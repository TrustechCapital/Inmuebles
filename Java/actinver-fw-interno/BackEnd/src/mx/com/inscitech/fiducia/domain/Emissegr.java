...
@PrimaryKey(constraintName = "EMISSEGR_PK", columns = {"ESE_NUM_PROGRAMA", "ESE_NUM_EMISION", "ESE_NUM_SEC_CUPON"}, sequences = { "MANUAL" })
public class Emissegr extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM EMISSEGR ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE EMISSEGR SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO EMISSEGR ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM EMISSEGR WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Emissegr instance = (Emissegr)compareWith;
