  ...
  public void run() {
    ...
    try {
      ...
      while(tasFileReader.ready()) {
        ...
        if(!archivosPlanos.doInsert()) throw new Exception("Error al cargar la informacion de archivo a base de datos!");
      ...
      parametrosQuery = null;
        ...
        logger.log(this, Thread.currentThread(), LoggingService.LEVEL.ERROR, "Error al pricesar archivo GarLiq", e);
