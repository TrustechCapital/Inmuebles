...
public class FEventosr extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM F_EVENTOSR ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE F_EVENTOSR SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO F_EVENTOSR ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM F_EVENTOSR WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    FEventosr instance = (FEventosr)compareWith;
  ...
  public Object selectAsObject() {
    FEventosr result = new FEventosr();
