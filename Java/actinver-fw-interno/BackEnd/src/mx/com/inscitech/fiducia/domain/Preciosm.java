...
@PrimaryKey(constraintName = "PRECIOSM_PK", columns = {"PRE_ANO_PREC_EMIS", "PRE_MES_PREC_EMIS", "PRE_DIA_PREC_EMIS", "PRE_NUM_SEC_EMIS", "PRE_CVE_TIPO_MERCA", "PRE_NUM_INSTRUME"}, sequences = { "MANUAL" })
public class Preciosm extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM PRECIOSM ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE PRECIOSM SET ";
    ...
    conditions += " AND PRE_CVE_TIPO_MERCA = ?";
    pkValues.add(this.getPreCveTipoMerca());
    conditions += " AND PRE_NUM_INSTRUME = ?";
    pkValues.add(this.getPreNumInstrume());
    conditions += " AND PRE_NUM_SEC_EMIS = ?";
    pkValues.add(this.getPreNumSecEmis());
    conditions += " AND PRE_ANO_PREC_EMIS = ?";
    pkValues.add(this.getPreAnoPrecEmis());
    conditions += " AND PRE_MES_PREC_EMIS = ?";
    pkValues.add(this.getPreMesPrecEmis());
    conditions += " AND PRE_DIA_PREC_EMIS = ?";
    pkValues.add(this.getPreDiaPrecEmis());
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO PRECIOSM ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM PRECIOSM WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Preciosm instance = (Preciosm)compareWith;
