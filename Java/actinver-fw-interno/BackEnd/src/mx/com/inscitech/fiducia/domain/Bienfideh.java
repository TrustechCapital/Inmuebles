...
@PrimaryKey(constraintName = "BIENFIDEH_PK", columns = {"BIE_NUM_CONTRATO", "BIE_SUB_CONTRATO", "BIE_CVE_TIPO_BIEN", "BIE_ID_BIEN"}, sequences = { "MANUAL" })
public class Bienfideh extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM BIENFIDEH ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE BIENFIDEH SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO BIENFIDEH ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM BIENFIDEH WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Bienfideh instance = (Bienfideh)compareWith;
  ...
  public Object selectAsObject() {
    Bienfideh result = new Bienfideh();
