...
@PrimaryKey(constraintName = "POSICION_PK", columns = {"POS_SUB_CONTRATO", "POS_NUM_ENTID_FIN", "POS_CONTRATO_INTER", "POS_NUM_CONTRATO", "POS_NUM_SEC_EMIS", "POS_CVE_TIPO_MERCA", "POS_NUM_INSTRUME"}, sequences = { "MANUAL" })
public class Posicion extends DomainObject {
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM POSICION WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Posicion instance = (Posicion)compareWith;
