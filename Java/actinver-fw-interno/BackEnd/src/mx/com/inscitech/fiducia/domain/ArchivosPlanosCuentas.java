...
public class ArchivosPlanosCuentas extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM ARCHIVOS_PLANOS_CUENTAS ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE ARCHIVOS_PLANOS_CUENTAS SET ";
    ...
    values.add(this.getApcSecuencial());
    fields += " APC_FECHA = TO_DATE(?, 'dd/MM/yyyy'), ";
    values.add(this.getApcFecha());
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO ARCHIVOS_PLANOS_CUENTAS ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM ARCHIVOS_PLANOS_CUENTAS WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    ArchivosPlanosCuentas instance = (ArchivosPlanosCuentas)compareWith;
  ...
  public Object selectAsObject() {
    ArchivosPlanosCuentas result = new ArchivosPlanosCuentas();
