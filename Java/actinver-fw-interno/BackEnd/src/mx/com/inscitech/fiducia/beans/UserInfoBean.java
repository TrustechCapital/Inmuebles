 ...
 public Integer getLogin() {
  ...
  public String getStrFechaContable() {
    ...
    switch(mesActual.intValue()){
      case 1: strFecha += "Enero de " + this.getFechaContable().split("/")[2]; break;
      case 2: strFecha += "Febrero de " + this.getFechaContable().split("/")[2]; break;
      case 3: strFecha += "Marzo de " + this.getFechaContable().split("/")[2]; break;
      case 4: strFecha += "Abril de " + this.getFechaContable().split("/")[2]; break;
      case 5: strFecha += "Mayo de " + this.getFechaContable().split("/")[2]; break;
      case 6: strFecha += "Junio de " + this.getFechaContable().split("/")[2]; break;
      case 7: strFecha += "Julio de " + this.getFechaContable().split("/")[2]; break;
      case 8: strFecha += "Agosto de " + this.getFechaContable().split("/")[2]; break;
      case 9: strFecha += "Septiembre de " + this.getFechaContable().split("/")[2]; break;
      case 10: strFecha += "Octubre de " + this.getFechaContable().split("/")[2]; break;
      case 11: strFecha += "Noviembre de " + this.getFechaContable().split("/")[2]; break;
      case 12: strFecha += "Diciembre de " + this.getFechaContable().split("/")[2]; break;
    }
    return strFecha;
  }
}