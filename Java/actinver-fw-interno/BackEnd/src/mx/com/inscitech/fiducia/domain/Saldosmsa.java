...
@PrimaryKey(constraintName = "SALDOSMSA_PK", columns = {"SAL_NUM_AUX1", "SAL_NUM_CTAM", "SAL_NUM_SCTA", "SAL_NUM_SSCTA", "SAL_NUM_SSSCTA", "SAL_NUM_SSSSCTA", "SAL_NUM_SSSSSCTA", "SAL_NUM_AUX2", "SAL_NUM_AUX3"}, sequences = { "MANUAL" })
public class Saldosmsa extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM SALDOSMSA ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE SALDOSMSA SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO SALDOSMSA ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM SALDOSMSA WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Saldosmsa instance = (Saldosmsa)compareWith;
  ...
  public Object selectAsObject() {
    Saldosmsa result = new Saldosmsa();
