...
@PrimaryKey(constraintName = "INSTRUCC_PK", columns = {"INS_NUM_FOLIO_INST", "INS_NUM_CONTRATO"}, sequences = { "MANUAL" })
public class Instrucc extends DomainObject {
  ...
  public boolean doCompare(Object compareWith) {
    ...
    if(equalObjects && !this.getAcuId().equals(instance.getAcuId())) equalObjects = false;
      if(equalObjects && !this.getInsNumOper().equals(instance.getInsNumOper())) equalObjects = false;
    return equalObjects;
  }
