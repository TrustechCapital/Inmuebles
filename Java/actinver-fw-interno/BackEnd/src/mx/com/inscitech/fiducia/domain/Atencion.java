...
@PrimaryKey(constraintName = "ATENCION_PK", columns = {"ATE_CVE_BANCA", "ATE_EJEC_ATENCION", "ATE_NUM_CONTRATO"}, sequences = { "MANUAL" })
public class Atencion extends DomainObject {
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM ATENCION WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Atencion instance = (Atencion)compareWith;
