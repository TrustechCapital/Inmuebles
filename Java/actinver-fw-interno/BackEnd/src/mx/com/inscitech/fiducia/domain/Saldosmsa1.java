...
public class Saldosmsa1 extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM SALDOSMSA_1 ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE SALDOSMSA_1 SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO SALDOSMSA_1 ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM SALDOSMSA_1 WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Saldosmsa1 instance = (Saldosmsa1)compareWith;
  ...
  public Object selectAsObject() {
    Saldosmsa1 result = new Saldosmsa1();
