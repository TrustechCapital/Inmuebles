...
public class Personalh extends DomainObject {
  ...
  @FieldInfo(nullable = false, dataType = "NUMBER", precision = 10, scale = 2, javaClass = BigDecimal.class )
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM PERSONALH ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE PERSONALH SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO PERSONALH ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM PERSONALH WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Personalh instance = (Personalh)compareWith;
  ...
  public Object selectAsObject() {
    Personalh result = new Personalh();
