...
@PrimaryKey(constraintName = "ARCHIVOS_PLANOS_PK", columns = {"ARP_SECUENCIAL", "ARP_FECHA", "ARP_NOM_ARCHIVO"}, sequences = { "MANUAL" })
public class ArchivosPlanos extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM ARCHIVOS_PLANOS ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE ARCHIVOS_PLANOS SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO ARCHIVOS_PLANOS ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM ARCHIVOS_PLANOS WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    ArchivosPlanos instance = (ArchivosPlanos)compareWith;
  ...
  public Object selectAsObject() {
    ArchivosPlanos result = new ArchivosPlanos();
