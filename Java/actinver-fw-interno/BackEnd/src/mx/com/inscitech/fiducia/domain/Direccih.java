...
@PrimaryKey(constraintName = "DIRECCIH_PK", columns = {"DIR_NUM_CONTRATO", "DIR_NUM_SEC_DIRECC", "DIR_CVE_PERS_FID", "DIR_NUM_PERS_FID"}, sequences = { "MANUAL" })
public class Direccih extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM DIRECCIH ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE DIRECCIH SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO DIRECCIH ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM DIRECCIH WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Direccih instance = (Direccih)compareWith;
