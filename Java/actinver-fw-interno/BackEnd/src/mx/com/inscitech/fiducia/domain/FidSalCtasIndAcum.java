...
@PrimaryKey(constraintName = "PK_SAL_CTAS_IND_ACUM", columns = {"SAL_FECHA_OPERA", "SAL_CONTRATO", "SAL_CLAVE_INV"}, sequences = { "MANUAL" })
public class FidSalCtasIndAcum extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM FID_SAL_CTAS_IND_ACUM ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE FID_SAL_CTAS_IND_ACUM SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO FID_SAL_CTAS_IND_ACUM ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM FID_SAL_CTAS_IND_ACUM WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    FidSalCtasIndAcum instance = (FidSalCtasIndAcum)compareWith;
  ...
  public Object selectAsObject() {
    FidSalCtasIndAcum result = new FidSalCtasIndAcum();
