...
public class ArchivosPlanosTas extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM ARCHIVOS_PLANOS_TAS ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE ARCHIVOS_PLANOS_TAS SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO ARCHIVOS_PLANOS_TAS ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM ARCHIVOS_PLANOS_TAS WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    ArchivosPlanosTas instance = (ArchivosPlanosTas)compareWith;
  ...
  public Object selectAsObject() {
    ArchivosPlanosTas result = new ArchivosPlanosTas();
