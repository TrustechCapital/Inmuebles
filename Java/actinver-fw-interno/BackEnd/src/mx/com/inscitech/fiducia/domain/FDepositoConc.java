...
public class FDepositoConc extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM F_DEPOSITO_CONC ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE F_DEPOSITO_CONC SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO F_DEPOSITO_CONC ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM F_DEPOSITO_CONC WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    FDepositoConc instance = (FDepositoConc)compareWith;
  ...
  public Object selectAsObject() {
    FDepositoConc result = new FDepositoConc();
