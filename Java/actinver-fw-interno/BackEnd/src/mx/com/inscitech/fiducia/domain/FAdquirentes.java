...
@PrimaryKey(constraintName = "F_ADQUIRENTES_PK", columns = {"FADQ_ID_FIDEICOMISO", "FADQ_ID_SUBCUENTA", "FADQ_ID_BIEN", "FADQ_ID_DEPTO", "FADQ_ID_VENTA"}, sequences = { "MANUAL" })
public class FAdquirentes extends DomainObject {
  ...
  public boolean doCompare(Object compareWith) {
    ...
    if(equalObjects && !this.getFadqIdFideicomiso().equals(instance.getFadqIdFideicomiso())) equalObjects = false;
    if(equalObjects && !this.getFadqIdSubcuenta().equals(instance.getFadqIdSubcuenta())) equalObjects = false;
    if(equalObjects && !this.getFadqIdBien().equals(instance.getFadqIdBien())) equalObjects = false;
    if(equalObjects && !this.getFadqIdDepto().equals(instance.getFadqIdDepto())) equalObjects = false;
    if(equalObjects && !this.getFadqIdVenta().equals(instance.getFadqIdVenta())) equalObjects = false;
    if(equalObjects && !this.getFadqPeriodo().equals(instance.getFadqPeriodo())) equalObjects = false;
    if(equalObjects && !this.getFadqNombreComprador().equals(instance.getFadqNombreComprador())) equalObjects = false;
    if(equalObjects && !this.getFadqValor().equals(instance.getFadqValor())) equalObjects = false;
    if(equalObjects && !this.getFadqMoneda().equals(instance.getFadqMoneda())) equalObjects = false;
    if(equalObjects && !this.getFadqTipoVenta().equals(instance.getFadqTipoVenta())) equalObjects = false;
    if(equalObjects && !this.getFadqTipoPlazo().equals(instance.getFadqTipoPlazo())) equalObjects = false;
    if(equalObjects && !this.getFadqNumPlazo().equals(instance.getFadqNumPlazo())) equalObjects = false;
    if(equalObjects && !this.getFadqEnganche().equals(instance.getFadqEnganche())) equalObjects = false;
    if(equalObjects && !this.getFadqAbono().equals(instance.getFadqAbono())) equalObjects = false;
    if(equalObjects && !this.getFadqSaldo().equals(instance.getFadqSaldo())) equalObjects = false;
    if(equalObjects && !this.getFadqPagos().equals(instance.getFadqPagos())) equalObjects = false;
    if(equalObjects && !this.getFadqNotario().equals(instance.getFadqNotario())) equalObjects = false;
    if(equalObjects && !this.getFadqLocalidad().equals(instance.getFadqLocalidad())) equalObjects = false;
    if(equalObjects && !this.getFadqCv().equals(instance.getFadqCv())) equalObjects = false;
    if(equalObjects && !this.getFadqContrato().equals(instance.getFadqContrato())) equalObjects = false;
    if(equalObjects && !this.getFadqFolio().equals(instance.getFadqFolio())) equalObjects = false;
    if(equalObjects && !this.getFadqRegPub().equals(instance.getFadqRegPub())) equalObjects = false;
    if(equalObjects && !this.getFadqFecAlta().equals(instance.getFadqFecAlta())) equalObjects = false;
    if(equalObjects && !this.getFadqFecMod().equals(instance.getFadqFecMod())) equalObjects = false;
    if(equalObjects && !this.getFadqStatus().equals(instance.getFadqStatus())) equalObjects = false;
      if(equalObjects && !this.getFadqExpCatast().equals(instance.getFadqExpCatast())) equalObjects = false;
      
      if(equalObjects && !this.getFadqPrototipo().equals(instance.getFadqPrototipo())) equalObjects = false;
      if(equalObjects && !this.getFadqNumeroOficial().equals(instance.getFadqNumeroOficial())) equalObjects = false;
      if(equalObjects && !this.getFadqNotaria().equals(instance.getFadqNotaria())) equalObjects = false;
      if(equalObjects && !this.getFadqDelegadoFiduciario().equals(instance.getFadqDelegadoFiduciario())) equalObjects = false;
    return equalObjects;
  }
