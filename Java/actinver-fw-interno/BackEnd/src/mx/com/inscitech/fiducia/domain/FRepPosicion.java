...
public class FRepPosicion extends DomainObject {
  ...
  String posiCol9 = null;
  String posiCol10 = null;
  String posiCol11 = null;
  ...
  @FieldInfo(nullable = true, dataType = "VARCHAR2", javaClass = String.class )
  public void setPosiCol9(String posiCol9) {
    this.posiCol9 = posiCol9;
  }

  public String getPosiCol9() {
    return this.posiCol9;
  }

  @FieldInfo(nullable = true, dataType = "VARCHAR2", javaClass = String.class )
  public void setPosiCol10(String posiCol10) {
    this.posiCol10 = posiCol10;
  }

  public String getPosiCol10() {
    return this.posiCol10;
  }

  @FieldInfo(nullable = true, dataType = "VARCHAR2", javaClass = String.class )
  public void setPosiCol11(String posiCol11) {
    this.posiCol11 = posiCol11;
  }

  public String getPosiCol11() {
    return this.posiCol11;
  }

  public DMLObject getSelectByPK() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "SELECT * FROM F_REP_POSICION ";
  ...
  public DMLObject getSelect() {
    ...
    if(this.getPosiCol9() != null && "null".equals(this.getPosiCol9())) {
      conditions += " AND POSI_COL9 IS NULL";
    } else if(this.getPosiCol9() != null) {
      conditions += " AND POSI_COL9 = ?";
      values.add(this.getPosiCol9());
    }

    if(this.getPosiCol10() != null && "null".equals(this.getPosiCol10())) {
      conditions += " AND POSI_COL10 IS NULL";
    } else if(this.getPosiCol10() != null) {
      conditions += " AND POSI_COL10 = ?";
      values.add(this.getPosiCol10());
    }

    if(this.getPosiCol11() != null && "null".equals(this.getPosiCol11())) {
      conditions += " AND POSI_COL11 IS NULL";
    } else if(this.getPosiCol11() != null) {
      conditions += " AND POSI_COL11 = ?";
      values.add(this.getPosiCol11());
    }
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE F_REP_POSICION SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO F_REP_POSICION ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM F_REP_POSICION WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    FRepPosicion instance = (FRepPosicion)compareWith;
    ...
    if(equalObjects && !this.getPosiCol9().equals(instance.getPosiCol9())) equalObjects = false;
    if(equalObjects && !this.getPosiCol10().equals(instance.getPosiCol10())) equalObjects = false;
    if(equalObjects && !this.getPosiCol11().equals(instance.getPosiCol11())) equalObjects = false;
    return equalObjects;
  }

  public Object selectAsObject() {
    FRepPosicion result = new FRepPosicion();
    ...
    result.setPosiCol9((String)objectData.getData("POSI_COL9"));
    result.setPosiCol10((String)objectData.getData("POSI_COL10"));
    result.setPosiCol11((String)objectData.getData("POSI_COL11"));
