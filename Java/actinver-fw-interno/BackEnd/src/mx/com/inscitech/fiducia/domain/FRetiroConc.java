...
public class FRetiroConc extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM F_RETIRO_CONC ";
  ...
  public DMLObject getSelect() {
    ...
    if(this.getFretCuentaDomiciliarioSwift() != null && this.getFretCuentaDomiciliarioSwift().longValue() == -999) {
    ...
    if(this.getFretMonedaDomiciliarioSwift() != null && this.getFretMonedaDomiciliarioSwift().longValue() == -999) {
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE F_RETIRO_CONC SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO F_RETIRO_CONC ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM F_RETIRO_CONC WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    FRetiroConc instance = (FRetiroConc)compareWith;
    boolean equalObjects = true;
    if(equalObjects && !this.getFretIdRetiro().equals(instance.getFretIdRetiro())) equalObjects = false;
    if(equalObjects && !this.getFretImpRetiro().equals(instance.getFretImpRetiro())) equalObjects = false;
    if(equalObjects && !this.getFretFecha().equals(instance.getFretFecha())) equalObjects = false;
    if(equalObjects && !this.getFretMoneda().equals(instance.getFretMoneda())) equalObjects = false;
    if(equalObjects && !this.getFretDescripcion().equals(instance.getFretDescripcion())) equalObjects = false;
    ...
    if(equalObjects && !this.getFretConcepto().equals(instance.getFretConcepto())) equalObjects = false;
    if(equalObjects && !this.getFretTipoLiquidacion().equals(instance.getFretTipoLiquidacion())) equalObjects = false;
    if(equalObjects && !this.getFretStatusRet().equals(instance.getFretStatusRet())) equalObjects = false;
    if(equalObjects && !this.getFretNomBeneficiario().equals(instance.getFretNomBeneficiario())) equalObjects = false;
    if(equalObjects && !this.getFretReferenciaCie().equals(instance.getFretReferenciaCie())) equalObjects = false;
    if(equalObjects && !this.getFretPaisDomiciliarioSwift().equals(instance.getFretPaisDomiciliarioSwift())) equalObjects = false;
    if(equalObjects && !this.getFretCiudadDomiciliarioSwift().equals(instance.getFretCiudadDomiciliarioSwift())) equalObjects = false;
    if(equalObjects && !this.getFretPlazaDomiciliarioSwift().equals(instance.getFretPlazaDomiciliarioSwift())) equalObjects = false;
    if(equalObjects && !this.getFretSucursalDomiciliaSwift().equals(instance.getFretSucursalDomiciliaSwift())) equalObjects = false;
    if(equalObjects && !this.getFretBancoDomiciliarioSwift().equals(instance.getFretBancoDomiciliarioSwift())) equalObjects = false;
    if(equalObjects && !this.getFretCuentaDomiciliarioSwift().equals(instance.getFretCuentaDomiciliarioSwift())) equalObjects = false;
    if(equalObjects && !this.getFretBranchDomiciliarioSwift().equals(instance.getFretBranchDomiciliarioSwift())) equalObjects = false;
    if(equalObjects && !this.getFretMonedaDomiciliarioSwift().equals(instance.getFretMonedaDomiciliarioSwift())) equalObjects = false;
    if(equalObjects && !this.getFretImporteMeSwift().equals(instance.getFretImporteMeSwift())) equalObjects = false;
    if(equalObjects && !this.getFretCodigoSaiSwift().equals(instance.getFretCodigoSaiSwift())) equalObjects = false;
    if(equalObjects && !this.getFretTipoAbaIbanSwift().equals(instance.getFretTipoAbaIbanSwift())) equalObjects = false;
    if(equalObjects && !this.getFretNomBeneficiSwift().equals(instance.getFretNomBeneficiSwift())) equalObjects = false;
    if(equalObjects && !this.getFretPaisBeneficiSwift().equals(instance.getFretPaisBeneficiSwift())) equalObjects = false;
    if(equalObjects && !this.getFretCiudadBeneficiSwift().equals(instance.getFretCiudadBeneficiSwift())) equalObjects = false;
    if(equalObjects && !this.getFretDimicilioBeneficiSwift().equals(instance.getFretDimicilioBeneficiSwift())) equalObjects = false;
    if(equalObjects && !this.getFretTelefonoBeneficiSwift().equals(instance.getFretTelefonoBeneficiSwift())) equalObjects = false;
    if(equalObjects && !this.getFretTipoCambioProv().equals(instance.getFretTipoCambioProv())) equalObjects = false;
    if(equalObjects && !this.getFretTipoCambioFirme().equals(instance.getFretTipoCambioFirme())) equalObjects = false;
    if(equalObjects && !this.getFcbaClabeCba().equals(instance.getFcbaClabeCba())) equalObjects = false;
    if(equalObjects && !this.getFretConvenioCie().equals(instance.getFretConvenioCie())) equalObjects = false;
    if(equalObjects && !this.getFfidIdFideicomiso().equals(instance.getFfidIdFideicomiso())) equalObjects = false;
    if(equalObjects && !this.getFretCtaCheques().equals(instance.getFretCtaCheques())) equalObjects = false;
    if(equalObjects && !this.getFretSubcta().equals(instance.getFretSubcta())) equalObjects = false;
    return equalObjects;
  }

  public Object selectAsObject() {
    FRetiroConc result = new FRetiroConc();
