...
@PrimaryKey(constraintName = "FINALIDA_ANTEPROY_PK", columns = {"FIN_NUM_CONTRATO", "FIN_CVE_TIPO_FINAL", "FIN_FOLIO_FINALIDA_ANTEPROY"}, sequences = { "MANUAL" })
public class FinalidaAnteproy extends DomainObject {

  BigDecimal finNumContrato = null;
  BigDecimal finFolioFinalidaAnteproy = null;
  ...
  @FieldInfo(nullable = false, dataType = "NUMBER", precision = 10, scale = 0, javaClass = BigDecimal.class )
  public void setfinFolioFinalidaAnteproy(BigDecimal finFolioFinalidaAnteproy) {
    this.finFolioFinalidaAnteproy = finFolioFinalidaAnteproy;
  }

  public BigDecimal getfinFolioFinalidaAnteproy() {
    return this.finFolioFinalidaAnteproy;
  }
  ...
  public DMLObject getSelectByPK() {
    ...
    if(this.getfinFolioFinalidaAnteproy() != null && this.getfinFolioFinalidaAnteproy().longValue() == -999) {
      conditions += " AND FIN_FOLIO_FINALIDA_ANTEPROY IS NULL";
    } else if(this.getfinFolioFinalidaAnteproy() != null) {
      conditions += " AND FIN_FOLIO_FINALIDA_ANTEPROY = ?";
      values.add(this.getfinFolioFinalidaAnteproy());
    }
  ...
  public DMLObject getUpdate() {
    ...
    conditions += " AND FIN_FOLIO_FINALIDA_ANTEPROY = ?";
    pkValues.add(this.getfinFolioFinalidaAnteproy());
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO FINALIDA_ANTEPROY (FIN_FOLIO_FINALIDA_ANTEPROY, ";
    ...
    /*fields += ", FIN_FOLIO_FINALIDA_ANTEPROY";
    fieldValues += ", ?";
    values.add(this.getfinFolioFinalidaAnteproy());*/
    ...
    sql += fields + " ) VALUES (FINALIDA_APROY_FOLIO_SEQ.NEXTVAL, " + fieldValues + ")";
  ...
  public boolean doCompare(Object compareWith) {
    FinalidaAnteproy instance = (FinalidaAnteproy)compareWith;
    boolean equalObjects = true;
    if(equalObjects && !this.getFinNumContrato().equals(instance.getFinNumContrato())) equalObjects = false;
    if(equalObjects && !this.getfinFolioFinalidaAnteproy().equals(instance.getfinFolioFinalidaAnteproy())) equalObjects = false;
  ...
  public Object selectAsObject() {
    FinalidaAnteproy result = new FinalidaAnteproy();
    DataRow objectData = null;
    objectData = selectAsDataRow();

    result.setFinNumContrato((BigDecimal)objectData.getData("FIN_NUM_CONTRATO"));
    result.setfinFolioFinalidaAnteproy((BigDecimal)objectData.getData("FIN_FOLIO_FINALIDA_ANTEPROY"));
