...
@PrimaryKey(constraintName = "VENTEMIS_PK", columns = {"VTE_NUM_PIZARRA", "VTE_NUM_SER_EMIS", "VTE_NUM_CUPON_VIG", "VTE_DIA_VENTA", "VTE_SEC_DIA_VTA", "VTE_FOLIO_OPER_CPA", "VTE_SUB_CONTRATO", "VTE_CONTRATO_INTER", "VTE_NUM_CONTRATO", "VTE_ENTIDAD_FIN"}, sequences = { "MANUAL" })
public class Ventemis extends DomainObject {
  ...
  public DMLObject getSelectByPK() {
    ...
    String sql = "SELECT * FROM VENTEMIS ";
  ...
  public DMLObject getUpdate() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "UPDATE VENTEMIS SET ";
  ...
  public DMLObject getInsert() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "INSERT INTO VENTEMIS ( ";
  ...
  public DMLObject getDelete() {
    if(!retrieveSQL) return null;
    DMLObject result = new DMLObject();
    String sql = "DELETE FROM VENTEMIS WHERE ";
  ...
  public boolean doCompare(Object compareWith) {
    Ventemis instance = (Ventemis)compareWith;
