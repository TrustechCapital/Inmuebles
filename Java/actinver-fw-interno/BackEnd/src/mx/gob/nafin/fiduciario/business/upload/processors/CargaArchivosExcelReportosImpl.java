...
public class CargaArchivosExcelReportosImpl extends UploadProcessor {
    ...
    public CargaArchivosExcelReportosImpl() {
        super();
    }
                    ...
                    for(col = 0; col < 17; col++) {
                      if(col!=10&col!=8&col!=9&col!=3)  {
                       ...
                       // Cell cell1 = excelReader.get .getRow(i).getCell(0);
                        ...
                        if(col==0||col==3||col==4||col==11||col==12||col==13||col==14||col==15||col==16 )//valores numericos
