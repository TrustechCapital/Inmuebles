 ...
 */
public class TasMercados extends UploadProcessor {
    ...
    public void run() {
        ...
        try {
            ...
            while (tasFileReader.ready()) {
                ...
                newline = line.replaceAll("H M", "").replaceAll("H F", "");

                if (line.length() > newline.length()) {

                    //newline = line.replaceAll("D2  ", "").replaceAll("D1  ", "").replaceAll("D1SP", "");
                    newline = line.replaceAll("D1  ", "").replaceAll("D1SP", "");
                    ...
                    if (line.length() == newline.length()) {
                        ...
                        archivosPlanos.setArpNomArchivo((String) this.getParameters().get("nombreValuacion"));
            ...
            logger.log(this, Thread.currentThread(), LoggingService.LEVEL.ERROR, "Error al pricesar archivo TAS Mercados", e);
        } finally {
