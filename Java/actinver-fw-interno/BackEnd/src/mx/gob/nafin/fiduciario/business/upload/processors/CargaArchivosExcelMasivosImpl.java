...
public class CargaArchivosExcelMasivosImpl extends UploadProcessor {
    ...
    public CargaArchivosExcelMasivosImpl() {
        super();
    }
                    ...
                    for(col = 0; col < 17; col++) {
                      if(col!=10&col!=8&col!=9&col!=3)  {
                       ...
                       // Cell cell1 = excelReader.get .getRow(i).getCell(0);
                        ...
                        if(col==0||col==3||col==4||col==6||col==7||col==9||col==10||col==12||col==16||col==17||col==19||col==20||col==21||col==22||col==23||col==24||col==25||col==26||col==27 )//valores numericos
                            line += excelReader.getNumericCellValue(false, "0").longValue() + ",";
                        else if(col==1||col==11){//valores date
