...
public class TasProcessorImplCapitales extends UploadProcessor {
    ...
    static {
        ...
        bodyInfo.add(new FieldInfo("Vector", new BigDecimal(27), "TraVector")); //CAMBIO PARA CONCILIACION DE CAPITALES
        bodyInfo.add(new FieldInfo("Precio de Mercado", new BigDecimal(23), "TraPrecioMerca")); //CAMBIO PARA CONCILIACION DE CAPITALES
    }
