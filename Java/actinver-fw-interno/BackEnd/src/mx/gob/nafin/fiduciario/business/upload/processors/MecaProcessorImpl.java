...
import mx.gob.nafin.fiduciario.business.upload.FieldInfo;
...
/**
 * Clase encargada de procesar los archivos recibidos para la interfaz del Meca
 * @author Inscitech México inscitech@inscitechmexico.com
 */
public class MecaProcessorImpl extends UploadProcessor {

    /**
     * Variable que tiene la informacion del header del archivo del Meca
     */
    private static List headerInfo;

    /**
     * Variable que tiene la informacion del cuerpo del archivo del Meca
     */
    ...
    static {
        ...
        bodyInfo.add(new FieldInfo("Parte del Archivo", new BigDecimal(1), "")); // Procesar solo los que tienen 3
    ...
    public void run() {
        ...
        logger.log(this, Thread.currentThread(), LoggingService.LEVEL.INFO, "Procesando Archivo Meca");
        ...
        try {
            ...
            parametrosQuery.add(new ParametroQueryBean("opcionTAS", "NUMBER", new Integer(4)));
            ...
            logger.log(this, Thread.currentThread(), LoggingService.LEVEL.ERROR, "Error al pricesar archivo Meca", e);
