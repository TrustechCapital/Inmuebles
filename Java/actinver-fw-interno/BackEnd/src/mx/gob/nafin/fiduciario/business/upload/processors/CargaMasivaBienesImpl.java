...
public class CargaMasivaBienesImpl extends UploadProcessor {
    ...
    public void run() {
            ...
            Integer idfideicomiso=0; Integer idBien=0; String edificio=""; String depto=""; String niveles="";
                                         ...
                                         String superficie1=""; String numeroCatastro=""; Double valorBien=0.0; Integer tipoValorBien=0;
                ...
                for(int i = 1; i < rowCount; i++) {
                    ...
                    try {
                        ...
                        idfideicomiso=pIdFideicomiso; idBien=0; edificio=""; depto=""; niveles="";
                                                     ...
                                                     superficie1=""; numeroCatastro="0"; valorBien=0.0; tipoValorBien=0;
                        ...
                        for(col = 0; col < 25; col++) {
                            ...
                            case 16:
                                ...
                                break;                        
                            case 17:
                                tipoValorBien=excelReader.getNumericCellValue(false, "0").intValue();    
                                break;                        
                            case 18:
